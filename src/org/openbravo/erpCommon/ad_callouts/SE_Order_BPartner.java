...
public class SE_Order_BPartner extends SimpleCallout {
    ...
    protected void execute(CalloutInfo info) throws ServletException {
        ...
        String strBPartner2 = info.vars.getStringParameter("inpcBpartnerId");
        info.addResult("inpemRcobRegdealer", OBDal.getInstance().get(BusinessPartner.class, strBPartner2).isRcobRegDealer() ? "Y" : "N");
        info.addResult("inpemRcobCommission", OBDal.getInstance().get(BusinessPartner.class, strBPartner2).getRcobCommission());
		info.addResult("inpemEpcgTin", OBDal.getInstance().get(BusinessPartner.class, strBPartner2).getEpcgTin());
