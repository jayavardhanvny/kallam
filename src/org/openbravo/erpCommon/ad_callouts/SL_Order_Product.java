...
public class SL_Order_Product extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String _strUOM,
    ...
    Product product = OBDal.getInstance().get(Product.class, strMProductID);
    String strProductCategory= product.getProductCategory().getId();
    //System.out.println("strProductCategory is" +strProductCategory);
    String strMake= product.getEpcgMake();
    //System.out.println("strMake is" +strMake);

    resultado.append("new Array(\"inpmProductCategoryId\", \"" + strProductCategory + "\"),\n");
    resultado.append("new Array(\"inpemEpcgMake\", \"" + strMake + "\")\n");

   
    resultado.append(");");
    //System.out.println("resultado is" +resultado);
