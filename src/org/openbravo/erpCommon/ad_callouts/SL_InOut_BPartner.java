...
public class SL_InOut_BPartner extends HttpSecureAppServlet {
  ...
  //suneetha code..
    ...
    BusinessPartner bpartnerobj = OBDal.getInstance().get(BusinessPartner.class, strBPartner);
    
    String strTin= bpartnerobj.getEpcgTin();
    System.out.println("strTin is" +strTin);
    resultado.append("new Array(\"inpemEpcgTin\", \"" + strTin + "\")\n");
