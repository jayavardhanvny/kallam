...
/**
 * Entity class for entity RCQA_Simplexstr (stored in table rcqa_simplexstr).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcqaSimplexstr extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rcqa_simplexstr";
    public static final String ENTITY_NAME = "RCQA_Simplexstr";
    ...
    public static final String PROPERTY_FH = "fh";
    public static final String PROPERTY_IH = "ih";
    public static final String PROPERTY_STRETCHPER = "stretchper";
    public static final String PROPERTY_RCPRCOUNTMASTER = "rcprCountmaster";

    public RcqaSimplexstr() {
    ...
    public BigDecimal getFh() {
        return (BigDecimal) get(PROPERTY_FH);
    }
    ...
    public BigDecimal getIh() {
        return (BigDecimal) get(PROPERTY_IH);
    }

    public void setIh(BigDecimal ih) {
        set(PROPERTY_IH, ih);
    }

    public BigDecimal getStretchper() {
        return (BigDecimal) get(PROPERTY_STRETCHPER);
    }

    public void setStretchper(BigDecimal stretchper) {
        set(PROPERTY_STRETCHPER, stretchper);
    }
