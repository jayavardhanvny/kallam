...
/**
 * Entity class for entity RCQA_Combersu (stored in table rcqa_combersu).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcqaCombersu extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rcqa_combersu";
    public static final String ENTITY_NAME = "RCQA_Combersu";
    ...
    public static final String PROPERTY_UPERCENTAGE = "upercentage";
    public static final String PROPERTY_MCVONE = "mcvone";
    public static final String PROPERTY_MCVTHREE = "mcvthree";
    ...
    public BigDecimal getUpercentage() {
        return (BigDecimal) get(PROPERTY_UPERCENTAGE);
    }

    public void setUpercentage(BigDecimal upercentage) {
        set(PROPERTY_UPERCENTAGE, upercentage);
    }

    public BigDecimal getMcvone() {
        return (BigDecimal) get(PROPERTY_MCVONE);
    }

    public void setMcvone(BigDecimal mcvone) {
        set(PROPERTY_MCVONE, mcvone);
    }

    public BigDecimal getMcvthree() {
        return (BigDecimal) get(PROPERTY_MCVTHREE);
    }

    public void setMcvthree(BigDecimal mcvthree) {
        set(PROPERTY_MCVTHREE, mcvthree);
    }
