...
/**
 * Entity class for entity RCQA_Rsbapercentage (stored in table rcqa_rsbapercentage).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcqaRsbapercentage extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rcqa_rsbapercentage";
    public static final String ENTITY_NAME = "RCQA_Rsbapercentage";
    ...
    public static final String PROPERTY_NMINUS1 = "nminus1";
    public static final String PROPERTY_NPLUS1 = "nplus1";
    public static final String PROPERTY_RCPRCOUNTMASTER = "rcprCountmaster";

    public RcqaRsbapercentage() {
    ...
    public BigDecimal getNminus1() {
        return (BigDecimal) get(PROPERTY_NMINUS1);
    }

    public void setNminus1(BigDecimal nminus1) {
        set(PROPERTY_NMINUS1, nminus1);
    }

    public BigDecimal getNplus1() {
        return (BigDecimal) get(PROPERTY_NPLUS1);
    }

    public void setNplus1(BigDecimal nplus1) {
        set(PROPERTY_NPLUS1, nplus1);
    }
