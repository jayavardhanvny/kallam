...
/**
 * Entity class for entity RCQA_Ringframeidle (stored in table rcqa_ringframeidle).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcqaRingframeidle extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rcqa_ringframeidle";
    public static final String ENTITY_NAME = "RCQA_Ringframeidle";
    ...
    public static final String PROPERTY_MECHANICALIDLE = "mechanicalidle";
    ...
    public BigDecimal getMechanicalidle() {
        return (BigDecimal) get(PROPERTY_MECHANICALIDLE);
    }

    public void setMechanicalidle(BigDecimal mechanicalidle) {
        set(PROPERTY_MECHANICALIDLE, mechanicalidle);
    }
