...
/**
 * Entity class for entity RCQA_Ringframebreak (stored in table rcqa_ringframebreak).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcqaRingframebreak extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rcqa_ringframebreak";
    public static final String ENTITY_NAME = "RCQA_Ringframebreak";
    ...
    public static final String PROPERTY_AVERAGEBREAKAGE = "averagebreakage";
    public static final String PROPERTY_SPEED = "speed";
    public static final String PROPERTY_RCPRCOUNTMASTER = "rcprCountmaster";

    public RcqaRingframebreak() {
    ...
    public BigDecimal getAveragebreakage() {
        return (BigDecimal) get(PROPERTY_AVERAGEBREAKAGE);
    }

    public void setAveragebreakage(BigDecimal averagebreakage) {
        set(PROPERTY_AVERAGEBREAKAGE, averagebreakage);
    }
