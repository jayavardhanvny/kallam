...
/**
 * Entity class for entity RCPR_PrLabour (stored in table RCPR_PrLabour).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_PrLabour extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_PrLabour";
    public static final String ENTITY_NAME = "RCPR_PrLabour";
    ...
    public static final String PROPERTY_CATEGORYRATE = "categoryRate";
    public static final String PROPERTY_UOM = "uOM";
    public static final String PROPERTY_BUSINESSPARTNER = "businessPartner";
    public static final String PROPERTY_OVERHEAD = "overhead";
    public static final String PROPERTY_PROCESSNOW = "processNow";
    public static final String PROPERTY_PROCESSED = "processed";
    public static final String PROPERTY_POSTED = "posted";
    public static final String PROPERTY_PROCESS = "process";

    public RCPR_PrLabour() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CATEGORYRATE, new BigDecimal(0));
        setDefaultValue(PROPERTY_OVERHEAD, new BigDecimal(0));
    ...
    public BigDecimal getCategoryRate() {
        return (BigDecimal) get(PROPERTY_CATEGORYRATE);
    }

    public void setCategoryRate(BigDecimal categoryRate) {
        set(PROPERTY_CATEGORYRATE, categoryRate);
    }
    ...
    public BigDecimal getOverhead() {
        return (BigDecimal) get(PROPERTY_OVERHEAD);
    }

    public void setOverhead(BigDecimal overhead) {
        set(PROPERTY_OVERHEAD, overhead);
    }
