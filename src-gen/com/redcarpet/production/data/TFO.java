...
/**
 * Entity class for entity RCPR_TFO (stored in table RCPR_Tfo).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class TFO extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_Tfo";
    public static final String ENTITY_NAME = "RCPR_TFO";
    ...
    public static final String PROPERTY_INITIALHANKS = "initialHanks";
    ...
    public BigDecimal getInitialHanks() {
        return (BigDecimal) get(PROPERTY_INITIALHANKS);
    }

    public void setInitialHanks(BigDecimal initialHanks) {
        set(PROPERTY_INITIALHANKS, initialHanks);
    }
