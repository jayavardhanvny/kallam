...
/**
 * Entity class for entity RCPR_Simplex (stored in table RCPR_Simplex).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_Simplex extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_Simplex";
    public static final String ENTITY_NAME = "RCPR_Simplex";
    ...
    public static final String PROPERTY_ALLOTTEDSPINDLE = "allottedspindle";
    public static final String PROPERTY_MACHINESTOPPAGEMINS = "machineStoppageMins";
    public static final String PROPERTY_NOOFIDLESPINDLES = "noOfIdleSpindles";
    ...
    public static final String PROPERTY_STDHANKSORSHIFT = "stdhanksorshift";
    public static final String PROPERTY_EFFICIENCY = "efficiency";
    public static final String PROPERTY_ACTUALPRODUCTKGS = "actualproductkgs";
    public static final String PROPERTY_PRDKGS = "prdkgs";
    ...
    public static final String PROPERTY_WORKEDSPINDLESORFRAME = "workedSpindlesOrFrame";
    ...
    public RCPR_Simplex() {
        ...
        setDefaultValue(PROPERTY_LBSTOKGSCONVERSION, new BigDecimal(0));
        setDefaultValue(PROPERTY_SHIFTTIMEINMINS, new BigDecimal(0));
        setDefaultValue(PROPERTY_MACHINEWORKINGMINS, new BigDecimal(0));
        setDefaultValue(PROPERTY_WORKEDSPINDLESORFRAME, new BigDecimal(0));
    }
    ...
    public BigDecimal getAllottedspindle() {
        return (BigDecimal) get(PROPERTY_ALLOTTEDSPINDLE);
    }

    public void setAllottedspindle(BigDecimal allottedspindle) {
        set(PROPERTY_ALLOTTEDSPINDLE, allottedspindle);
    }
    ...
    public BigDecimal getNoOfIdleSpindles() {
        return (BigDecimal) get(PROPERTY_NOOFIDLESPINDLES);
    }

    public void setNoOfIdleSpindles(BigDecimal noOfIdleSpindles) {
        set(PROPERTY_NOOFIDLESPINDLES, noOfIdleSpindles);
    }
    ...
    public BigDecimal getStdhanksorshift() {
        return (BigDecimal) get(PROPERTY_STDHANKSORSHIFT);
    }

    public void setStdhanksorshift(BigDecimal stdhanksorshift) {
        set(PROPERTY_STDHANKSORSHIFT, stdhanksorshift);
    }
    ...
    public BigDecimal getActualproductkgs() {
        return (BigDecimal) get(PROPERTY_ACTUALPRODUCTKGS);
    }

    public void setActualproductkgs(BigDecimal actualproductkgs) {
        set(PROPERTY_ACTUALPRODUCTKGS, actualproductkgs);
    }

    public BigDecimal getPrdkgs() {
        return (BigDecimal) get(PROPERTY_PRDKGS);
    }

    public void setPrdkgs(BigDecimal prdkgs) {
        set(PROPERTY_PRDKGS, prdkgs);
    }
    ...
    public BigDecimal getWorkedSpindlesOrFrame() {
        return (BigDecimal) get(PROPERTY_WORKEDSPINDLESORFRAME);
    }

    public void setWorkedSpindlesOrFrame(BigDecimal workedSpindlesOrFrame) {
        set(PROPERTY_WORKEDSPINDLESORFRAME, workedSpindlesOrFrame);
    }
