...
/**
 * Entity class for entity RCPR_PrBOMLines (stored in table RCPR_PrBOMLines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_PrBOMLines extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_PrBOMLines";
    public static final String ENTITY_NAME = "RCPR_PrBOMLines";
    ...
    public static final String PROPERTY_PRIMARYPRODUCT = "primaryProduct";
    public static final String PROPERTY_RATIO = "ratio";

    public RCPR_PrBOMLines() {
        ...
        setDefaultValue(PROPERTY_PRIMARYPRODUCT, false);
    }
    ...
    public Boolean isPrimaryProduct() {
        return (Boolean) get(PROPERTY_PRIMARYPRODUCT);
    }

    public void setPrimaryProduct(Boolean primaryProduct) {
        set(PROPERTY_PRIMARYPRODUCT, primaryProduct);
    }

    public BigDecimal getRatio() {
        return (BigDecimal) get(PROPERTY_RATIO);
    }

    public void setRatio(BigDecimal ratio) {
        set(PROPERTY_RATIO, ratio);
    }
