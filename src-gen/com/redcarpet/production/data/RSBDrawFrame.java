...
/**
 * Entity class for entity RCPR_RSBDrawFrame (stored in table RCPR_Rsbdrawframe).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RSBDrawFrame extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_Rsbdrawframe";
    public static final String ENTITY_NAME = "RCPR_RSBDrawFrame";
