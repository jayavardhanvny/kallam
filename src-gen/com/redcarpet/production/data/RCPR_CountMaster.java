...
/**
 * Entity class for entity RCPR_Countmaster (stored in table RCPR_Countmaster).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_CountMaster extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_Countmaster";
    public static final String ENTITY_NAME = "RCPR_Countmaster";
    ...
    public String getCountNumber() {
        return (String) get(PROPERTY_COUNTNUMBER);
    }
