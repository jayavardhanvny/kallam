...
/**
 * Entity class for entity RCPR_PrProcessLevel (stored in table RCPR_PrProcessLevel).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_PrProcessLevel extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_PrProcessLevel";
    public static final String ENTITY_NAME = "RCPR_PrProcessLevel";
