...
/**
 * Entity class for entity RCPR_PrBOMExpense (stored in table RCPR_PrBOMExpense).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_PrBOMExpense extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_PrBOMExpense";
    public static final String ENTITY_NAME = "RCPR_PrBOMExpense";
    ...
    public RCPR_PrExpenseType getExpenseType() {
        return (RCPR_PrExpenseType) get(PROPERTY_EXPENSETYPE);
    }

    public void setExpenseType(RCPR_PrExpenseType expenseType) {
