...
/**
 * Entity class for entity RCPR_Preventivemaintenance (stored in table RCPR_Preventivemaintenance).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPR_PreventiveMaintenanceOrder extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPR_Preventivemaintenance";
    public static final String ENTITY_NAME = "RCPR_Preventivemaintenance";
    ...
    public RCPR_PreventiveMaintenanceOrder() {
