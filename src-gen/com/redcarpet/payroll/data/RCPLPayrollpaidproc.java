...
/**
 * Entity class for entity RCPL_Payrollpaidproc (stored in table RCPL_Payrollpaidproc).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPLPayrollpaidproc extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_Payrollpaidproc";
    public static final String ENTITY_NAME = "RCPL_Payrollpaidproc";
    ...
    public static final String PROPERTY_ATPAYROLLPERIOD = "atpayrollperiod";
    public static final String PROPERTY_BYHAND = "byhand";
    public static final String PROPERTY_RCPLPAYROLLPAIDPROCLINELIST = "rCPLPayrollpaidproclineList";

    public RCPLPayrollpaidproc() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_ATPAYROLLPERIOD, false);
        setDefaultValue(PROPERTY_BYHAND, true);
    ...
    public Boolean isAtpayrollperiod() {
        return (Boolean) get(PROPERTY_ATPAYROLLPERIOD);
    }

    public void setAtpayrollperiod(Boolean atpayrollperiod) {
        set(PROPERTY_ATPAYROLLPERIOD, atpayrollperiod);
    }

    public Boolean isByhand() {
        return (Boolean) get(PROPERTY_BYHAND);
    }

    public void setByhand(Boolean byhand) {
        set(PROPERTY_BYHAND, byhand);
    }
