...
import com.rcss.humanresource.data.RCHR_Skill;
...
/**
 * Entity class for entity RCPL_ServiceWeightage (stored in table RCPL_ServiceWeightage).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPL_ServiceWeightage extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_ServiceWeightage";
    public static final String ENTITY_NAME = "RCPL_ServiceWeightage";
