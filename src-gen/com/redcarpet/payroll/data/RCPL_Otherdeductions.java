...
/**
 * Entity class for entity RCPL_Otherdeductions (stored in table RCPL_Otherdeductions).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPL_Otherdeductions extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_Otherdeductions";
    public static final String ENTITY_NAME = "RCPL_Otherdeductions";
