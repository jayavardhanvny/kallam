...
/**
 * Entity class for entity RCPL_EmpFine (stored in table RCPL_EmpFine).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcplEmpfine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_EmpFine";
    public static final String ENTITY_NAME = "RCPL_EmpFine";
    ...
    public static final String PROPERTY_FINEDATE = "finedate";
    public static final String PROPERTY_FINEAMOUNT = "fineamount";
    ...
    public RcplEmpfine() {
        ...
        setDefaultValue(PROPERTY_FINEAMOUNT, new BigDecimal(0));
    }
    ...
    public Date getFinedate() {
        return (Date) get(PROPERTY_FINEDATE);
    }

    public void setFinedate(Date finedate) {
        set(PROPERTY_FINEDATE, finedate);
    }

    public BigDecimal getFineamount() {
        return (BigDecimal) get(PROPERTY_FINEAMOUNT);
    }

    public void setFineamount(BigDecimal fineamount) {
        set(PROPERTY_FINEAMOUNT, fineamount);
    }
