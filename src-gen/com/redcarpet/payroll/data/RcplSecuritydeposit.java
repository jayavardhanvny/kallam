...
/**
 * Entity class for entity RCPL_SecurityDeposit (stored in table RCPL_SecurityDeposit).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcplSecuritydeposit extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_SecurityDeposit";
    public static final String ENTITY_NAME = "RCPL_SecurityDeposit";
