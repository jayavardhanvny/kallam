...
/**
 * Entity class for entity RCPL_PayAdditionsHead (stored in table RCPL_PayAdditionsHead).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCPL_PayAdditionsHead extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCPL_PayAdditionsHead";
    public static final String ENTITY_NAME = "RCPL_PayAdditionsHead";
