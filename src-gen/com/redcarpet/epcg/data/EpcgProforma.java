...
/**
 * Entity class for entity Epcg_Proforma (stored in table Epcg_Proforma).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EpcgProforma extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_Proforma";
    public static final String ENTITY_NAME = "Epcg_Proforma";
    ...
    public static final String PROPERTY_PROFORMADATE = "proformadate";
    public static final String PROPERTY_BUSINESSPARTNER = "businessPartner";
    public static final String PROPERTY_PARTNERADDRESS = "partnerAddress";
    public static final String PROPERTY_SALESORDER = "salesOrder";
    public static final String PROPERTY_COPYFROMSO = "copyfromso";
    ...
    public EpcgProforma() {
        ...
        setDefaultValue(PROPERTY_COPYFROMSO, false);
    ...
    public Date getProformadate() {
        return (Date) get(PROPERTY_PROFORMADATE);
    }

    public void setProformadate(Date proformadate) {
        set(PROPERTY_PROFORMADATE, proformadate);
    }
    ...
    public Boolean isCopyfromso() {
        return (Boolean) get(PROPERTY_COPYFROMSO);
    }

    public void setCopyfromso(Boolean copyfromso) {
        set(PROPERTY_COPYFROMSO, copyfromso);
    }
