...
/**
 * Entity class for entity Epcg_Weftcosting (stored in table Epcg_Weftcosting).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EpcgWeftcosting extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_Weftcosting";
    public static final String ENTITY_NAME = "Epcg_Weftcosting";
    ...
    public EpcgWeftcosting() {
        ...
        setDefaultValue(PROPERTY_WEFTRATEKGS, (long) 0);
        setDefaultValue(PROPERTY_WEFTWTKGSPERMTS, (long) 0);
        setDefaultValue(PROPERTY_WEFTWTKGSWITHWASTE, (long) 0);
    ...
    public Long getWeftratekgs() {
        return (Long) get(PROPERTY_WEFTRATEKGS);
    }

    public void setWeftratekgs(Long weftratekgs) {
        set(PROPERTY_WEFTRATEKGS, weftratekgs);
    }

    public Long getWeftwtkgspermts() {
        return (Long) get(PROPERTY_WEFTWTKGSPERMTS);
    }

    public void setWeftwtkgspermts(Long weftwtkgspermts) {
        set(PROPERTY_WEFTWTKGSPERMTS, weftwtkgspermts);
    }

    public Long getWeftwtkgswithwaste() {
        return (Long) get(PROPERTY_WEFTWTKGSWITHWASTE);
    }

    public void setWeftwtkgswithwaste(Long weftwtkgswithwaste) {
