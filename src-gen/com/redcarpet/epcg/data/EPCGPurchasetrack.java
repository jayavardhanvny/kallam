...
/**
 * Entity class for entity EPCG_Purchasetrack (stored in table EPCG_Purchasetrack).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EPCGPurchasetrack extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "EPCG_Purchasetrack";
    public static final String ENTITY_NAME = "EPCG_Purchasetrack";
