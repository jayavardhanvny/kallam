...
/**
 * Entity class for entity Epcg_Bpinsurance (stored in table Epcg_Bpinsurance).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Epcg_Bpinsurance extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_Bpinsurance";
    public static final String ENTITY_NAME = "Epcg_Bpinsurance";
    ...
    public static final String PROPERTY_INSURANCENO = "insuranceno";

    public Epcg_Bpinsurance() {
    ...
    public String getInsuranceno() {
        return (String) get(PROPERTY_INSURANCENO);
    }

    public void setInsuranceno(String insuranceno) {
        set(PROPERTY_INSURANCENO, insuranceno);
    }
