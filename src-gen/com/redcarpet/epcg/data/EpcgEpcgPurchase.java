...
/**
 * Entity class for entity Epcg_EpcgPurchase (stored in table Epcg_EpcgPurchase).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EpcgEpcgPurchase extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_EpcgPurchase";
    public static final String ENTITY_NAME = "Epcg_EpcgPurchase";
    ...
    public static final String PROPERTY_PROCESSPURCHASE = "processpurchase";

    public EpcgEpcgPurchase() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSPURCHASE, false);
    }
    ...
    public Boolean isProcesspurchase() {
        return (Boolean) get(PROPERTY_PROCESSPURCHASE);
    }

    public void setProcesspurchase(Boolean processpurchase) {
        set(PROPERTY_PROCESSPURCHASE, processpurchase);
    }
