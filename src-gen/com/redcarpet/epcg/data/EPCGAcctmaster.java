...
/**
 * Entity class for entity EPCG_Acctmaster (stored in table EPCG_Acctmaster).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EPCGAcctmaster extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "EPCG_Acctmaster";
    public static final String ENTITY_NAME = "EPCG_Acctmaster";
    ...
    public static final String PROPERTY_EPCGJACCOUNTLIST = "ePCGJaccountList";
    ...
    public EPCGAcctmaster() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_EPCGJACCOUNTLIST, new ArrayList<Object>());
    ...
    public List<EPCGJaccount> getEPCGJaccountList() {
        return (List<EPCGJaccount>) get(PROPERTY_EPCGJACCOUNTLIST);
    }

    public void setEPCGJaccountList(List<EPCGJaccount> ePCGJaccountList) {
        set(PROPERTY_EPCGJACCOUNTLIST, ePCGJaccountList);
    }
