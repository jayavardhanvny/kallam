...
/**
 * Entity class for entity Epcg_Delivermode (stored in table Epcg_Delivermode).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EpcgDelivermode extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_Delivermode";
    public static final String ENTITY_NAME = "Epcg_Delivermode";
