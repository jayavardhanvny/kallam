...
/**
 * Entity class for entity Epcg_Seqline (stored in table Epcg_Seqline).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EpcgSeqline extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Epcg_Seqline";
    public static final String ENTITY_NAME = "Epcg_Seqline";
    ...
    public EpcgSeqline() {
        ...
        setDefaultValue(PROPERTY_AUTONUMBERING, true);
    }
