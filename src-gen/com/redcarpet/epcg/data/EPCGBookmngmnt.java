...
/**
 * Entity class for entity EPCG_Bookmngmnt (stored in table EPCG_Bookmngmnt).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EPCGBookmngmnt extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "EPCG_Bookmngmnt";
    public static final String ENTITY_NAME = "EPCG_Bookmngmnt";
    ...
    public static final String PROPERTY_CHECKAMOUNT = "checkamount";
    public static final String PROPERTY_CASHPAIDON = "cashpaidon";
    public static final String PROPERTY_AMOUNT = "amount";
    public static final String PROPERTY_TRUCKNO = "truckno";

    public EPCGBookmngmnt() {
    ...
    public BigDecimal getCheckamount() {
        return (BigDecimal) get(PROPERTY_CHECKAMOUNT);
    }

    public void setCheckamount(BigDecimal checkamount) {
        set(PROPERTY_CHECKAMOUNT, checkamount);
    }

    public Date getCashpaidon() {
        return (Date) get(PROPERTY_CASHPAIDON);
    }

    public void setCashpaidon(Date cashpaidon) {
        set(PROPERTY_CASHPAIDON, cashpaidon);
    }
