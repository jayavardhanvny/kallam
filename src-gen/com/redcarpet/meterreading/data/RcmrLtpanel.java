...
/**
 * Entity class for entity Rcmr_Ltpanel (stored in table Rcmr_Ltpanel).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcmrLtpanel extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rcmr_Ltpanel";
    public static final String ENTITY_NAME = "Rcmr_Ltpanel";
