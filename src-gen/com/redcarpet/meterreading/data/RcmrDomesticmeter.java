...
/**
 * Entity class for entity Rcmr_Domesticmeter (stored in table Rcmr_Domesticmeter).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RcmrDomesticmeter extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rcmr_Domesticmeter";
    public static final String ENTITY_NAME = "Rcmr_Domesticmeter";
