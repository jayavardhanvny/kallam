...
/**
 * Entity class for entity RCHR_Inspgreigewidth (stored in table RCHR_Inspgreigewidth).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrInspgreigewidth extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Inspgreigewidth";
    public static final String ENTITY_NAME = "RCHR_Inspgreigewidth";
