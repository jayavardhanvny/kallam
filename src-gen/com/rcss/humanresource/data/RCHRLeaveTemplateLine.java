...
/**
 * Entity class for entity RCHR_LeaveTemplateLine (stored in table RCHR_LeaveTemplateLine).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRLeaveTemplateLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_LeaveTemplateLine";
    public static final String ENTITY_NAME = "RCHR_LeaveTemplateLine";
    ...
    public static final String PROPERTY_ISENCASHMENT = "isencashment";
    public static final String PROPERTY_PRESENTDAYS = "presentdays";

    public RCHRLeaveTemplateLine() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CARRYFORWARD, (long) 0);
        setDefaultValue(PROPERTY_ISENCASHMENT, false);
    ...
    public Long getCarryforward() {
        return (Long) get(PROPERTY_CARRYFORWARD);
    }
    ...
    public Boolean isEncashment() {
        return (Boolean) get(PROPERTY_ISENCASHMENT);
    }

    public void setEncashment(Boolean isencashment) {
        set(PROPERTY_ISENCASHMENT, isencashment);
    }
