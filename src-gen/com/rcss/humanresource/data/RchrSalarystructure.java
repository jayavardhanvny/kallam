...
/**
 * Entity class for entity RCHR_Salarystructure (stored in table RCHR_Salarystructure).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrSalarystructure extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Salarystructure";
    public static final String ENTITY_NAME = "RCHR_Salarystructure";
    ...
    public static final String PROPERTY_RCHRDESIGNATIONLIST = "rchrDesignationList";

    public RchrSalarystructure() {
        ...
        setDefaultValue(PROPERTY_RCHRDESIGNATIONLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<RchrDesignation> getRchrDesignationList() {
        return (List<RchrDesignation>) get(PROPERTY_RCHRDESIGNATIONLIST);
    }

    public void setRchrDesignationList(List<RchrDesignation> rchrDesignationList) {
        set(PROPERTY_RCHRDESIGNATIONLIST, rchrDesignationList);
    }
