...
/**
 * Entity class for entity RCHR_Attend_Temp (stored in table RCHR_Attend_Temp).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Attend_Temp extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Attend_Temp";
    public static final String ENTITY_NAME = "RCHR_Attend_Temp";
    ...
    public RCHR_Attend_Temp() {
        ...
        setDefaultValue(PROPERTY_IMPORT, false);
    ...
    public Boolean isImport() {
        return (Boolean) get(PROPERTY_IMPORT);
    }

    public void setImport(Boolean imprt) {
        set(PROPERTY_IMPORT, imprt);
    }
