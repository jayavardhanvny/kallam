...
/**
 * Entity class for entity Rchr_Holidays_List (stored in table Rchr_Holidays_List).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrHolidaysList extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rchr_Holidays_List";
    public static final String ENTITY_NAME = "Rchr_Holidays_List";
    ...
    public static final String PROPERTY_HOLIDAYDATE = "holidaydate";
    ...
    public Date getHolidaydate() {
        return (Date) get(PROPERTY_HOLIDAYDATE);
    }

    public void setHolidaydate(Date holidaydate) {
        set(PROPERTY_HOLIDAYDATE, holidaydate);
    }
