...
/**
 * Entity class for entity RCHR_Inspsheetlines (stored in table RCHR_Inspsheetlines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Inspsheetlines extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Inspsheetlines";
    public static final String ENTITY_NAME = "RCHR_Inspsheetlines";
    ...
    public static final String PROPERTY_METERNO = "meterno";
    ...
    public String getMeterno() {
        return (String) get(PROPERTY_METERNO);
    }

    public void setMeterno(String meterno) {
        set(PROPERTY_METERNO, meterno);
    }
