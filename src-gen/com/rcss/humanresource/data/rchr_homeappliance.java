...
/**
 * Entity class for entity rchr_homeappliance (stored in table rchr_homeappliance).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class rchr_homeappliance extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "rchr_homeappliance";
    public static final String ENTITY_NAME = "rchr_homeappliance";
