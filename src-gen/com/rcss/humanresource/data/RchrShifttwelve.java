...
/**
 * Entity class for entity Rchr_Shifttwelve (stored in table Rchr_Shifttwelve).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrShifttwelve extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rchr_Shifttwelve";
    public static final String ENTITY_NAME = "Rchr_Shifttwelve";
    ...
    public static final String PROPERTY_WEEKOFFDATE = "weekoffdate";
    public static final String PROPERTY_RCPRSHIFT = "rcprShift";

    public RchrShifttwelve() {
    ...
    public Date getWeekoffdate() {
        return (Date) get(PROPERTY_WEEKOFFDATE);
    }

    public void setWeekoffdate(Date weekoffdate) {
        set(PROPERTY_WEEKOFFDATE, weekoffdate);
    }
