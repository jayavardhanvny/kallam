...
/**
 * Entity class for entity RCHR_Preparatprodincntive (stored in table RCHR_Preparatprodincntive).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrPreparatprodincntive extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Preparatprodincntive";
    public static final String ENTITY_NAME = "RCHR_Preparatprodincntive";
    ...
    public static final String PROPERTY_YIELD = "yield";
    public static final String PROPERTY_AMOUNT = "amount";
    public static final String PROPERTY_RCPLLOOMCATEGORY = "rcplLoomcategory";

    public RchrPreparatprodincntive() {
    ...
    public Long getYield() {
        return (Long) get(PROPERTY_YIELD);
    }

    public void setYield(Long yield) {
        set(PROPERTY_YIELD, yield);
    }
