...
/**
 * Entity class for entity RCHR_Warpyarntype (stored in table RCHR_Warpyarntype).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRWarpyarntype extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Warpyarntype";
    public static final String ENTITY_NAME = "RCHR_Warpyarntype";
    ...
    public static final String PROPERTY_RCHRQUALITYSTANDARDWARPYARNTYPELIST = "rCHRQualitystandardWarpyarntypeList";

    public RCHRWarpyarntype() {
        ...
        setDefaultValue(PROPERTY_RCHRQUALITYSTANDARDWARPYARNTYPELIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<RCHRQualitystandard> getRCHRQualitystandardWarpyarntypeList() {
        return (List<RCHRQualitystandard>) get(PROPERTY_RCHRQUALITYSTANDARDWARPYARNTYPELIST);
    }

    public void setRCHRQualitystandardWarpyarntypeList(List<RCHRQualitystandard> rCHRQualitystandardWarpyarntypeList) {
        set(PROPERTY_RCHRQUALITYSTANDARDWARPYARNTYPELIST, rCHRQualitystandardWarpyarntypeList);
    }
