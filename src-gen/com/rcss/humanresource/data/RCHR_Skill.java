...
/**
 * Entity class for entity RCHR_Skill (stored in table RCHR_Skill).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Skill extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Skill";
    public static final String ENTITY_NAME = "RCHR_Skill";
    ...
    public static final String PROPERTY_SKILLNAME = "skillName";
    ...
    public String getSkillName() {
        return (String) get(PROPERTY_SKILLNAME);
    }

    public void setSkillName(String skillName) {
        set(PROPERTY_SKILLNAME, skillName);
    }
