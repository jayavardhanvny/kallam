...
/**
 * Entity class for entity Rchr_Rollmaster (stored in table Rchr_Rollmaster).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrRollmaster extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rchr_Rollmaster";
    public static final String ENTITY_NAME = "Rchr_Rollmaster";
    ...
    public static final String PROPERTY_YEARCHAR = "yearchar";
    ...
    public String getYearchar() {
        return (String) get(PROPERTY_YEARCHAR);
    }

    public void setYearchar(String yearchar) {
        set(PROPERTY_YEARCHAR, yearchar);
    }
