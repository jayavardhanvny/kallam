...
/**
 * Entity class for entity RCHR_PolicySlab (stored in table RCHR_PolicySlab).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_PolicySlab extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_PolicySlab";
    public static final String ENTITY_NAME = "RCHR_PolicySlab";
    ...
    public BigDecimal getPermium() {
        return (BigDecimal) get(PROPERTY_PERMIUM);
    }

    public void setPermium(BigDecimal permium) {
        set(PROPERTY_PERMIUM, permium);
    }
