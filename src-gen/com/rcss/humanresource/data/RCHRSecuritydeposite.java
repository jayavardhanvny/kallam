...
/**
 * Entity class for entity RCHR_Securitydeposite (stored in table RCHR_Securitydeposite).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRSecuritydeposite extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Securitydeposite";
    public static final String ENTITY_NAME = "RCHR_Securitydeposite";
    ...
    public static final String PROPERTY_RCHRSECDEPOSITELINESLIST = "rCHRSecdepositelinesList";

    public RCHRSecuritydeposite() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSING, false);
        setDefaultValue(PROPERTY_RCHRSECDEPOSITELINESLIST, new ArrayList<Object>());
    }
    ...
    public List<RCHRSecdepositelines> getRCHRSecdepositelinesList() {
        return (List<RCHRSecdepositelines>) get(PROPERTY_RCHRSECDEPOSITELINESLIST);
    }

    public void setRCHRSecdepositelinesList(List<RCHRSecdepositelines> rCHRSecdepositelinesList) {
        set(PROPERTY_RCHRSECDEPOSITELINESLIST, rCHRSecdepositelinesList);
    }
