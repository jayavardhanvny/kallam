...
/**
 * Entity class for entity RCHR_Overtimeheader (stored in table RCHR_OverTimeHeader).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_OverTimeHeader extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_OverTimeHeader";
    public static final String ENTITY_NAME = "RCHR_Overtimeheader";
