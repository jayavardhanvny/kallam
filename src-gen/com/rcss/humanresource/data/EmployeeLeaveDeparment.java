...
/**
 * Entity class for entity RCHR_Emp_LeaveDept (stored in table RCHR_Emp_LeaveDept).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EmployeeLeaveDeparment extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Emp_LeaveDept";
    public static final String ENTITY_NAME = "RCHR_Emp_LeaveDept";
