...
/**
 * Entity class for entity RCHR_JobDetails (stored in table RCHR_JobDetails).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRJobDetails extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_JobDetails";
    public static final String ENTITY_NAME = "RCHR_JobDetails";
    ...
    public static final String PROPERTY_CURRENTDEPARTMENT = "currentdepartment";
    public static final String PROPERTY_CURRENTSUBDEPARTMENT = "currentsubdepartment";
    public static final String PROPERTY_CURRENTDESIGNATION = "currentdesignation";

    public RCHRJobDetails() {
    ...
    public String getCurrentdepartment() {
        return (String) get(PROPERTY_CURRENTDEPARTMENT);
    }

    public void setCurrentdepartment(String currentdepartment) {
        set(PROPERTY_CURRENTDEPARTMENT, currentdepartment);
    }

    public String getCurrentsubdepartment() {
        return (String) get(PROPERTY_CURRENTSUBDEPARTMENT);
    }

    public void setCurrentsubdepartment(String currentsubdepartment) {
        set(PROPERTY_CURRENTSUBDEPARTMENT, currentsubdepartment);
    }

    public String getCurrentdesignation() {
        return (String) get(PROPERTY_CURRENTDESIGNATION);
    }

    public void setCurrentdesignation(String currentdesignation) {
        set(PROPERTY_CURRENTDESIGNATION, currentdesignation);
    }
