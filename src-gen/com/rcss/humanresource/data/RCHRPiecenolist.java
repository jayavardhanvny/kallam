...
/**
 * Entity class for entity RCHR_Piecenolist (stored in table RCHR_Piecenolist).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRPiecenolist extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Piecenolist";
    public static final String ENTITY_NAME = "RCHR_Piecenolist";
    ...
    public static final String PROPERTY_RCHRPIECEMASTER = "rchrPiecemaster";
    ...
    public RCHRPiecemaster getRchrPiecemaster() {
        return (RCHRPiecemaster) get(PROPERTY_RCHRPIECEMASTER);
    }

    public void setRchrPiecemaster(RCHRPiecemaster rchrPiecemaster) {
        set(PROPERTY_RCHRPIECEMASTER, rchrPiecemaster);
    }
