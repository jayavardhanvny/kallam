...
/**
 * Entity class for entity RCHR_Inspectiontype (stored in table RCHR_Inspectiontype).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRInspectiontype extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Inspectiontype";
    public static final String ENTITY_NAME = "RCHR_Inspectiontype";
    ...
    public static final String PROPERTY_RCHRINSPREMARKTYPE = "rchrInspremarktype";
    ...
    public RCHRInspremarktype getRchrInspremarktype() {
        return (RCHRInspremarktype) get(PROPERTY_RCHRINSPREMARKTYPE);
    }

    public void setRchrInspremarktype(RCHRInspremarktype rchrInspremarktype) {
        set(PROPERTY_RCHRINSPREMARKTYPE, rchrInspremarktype);
    }
