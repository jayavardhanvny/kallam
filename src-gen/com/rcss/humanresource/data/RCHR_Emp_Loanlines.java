...
/**
 * Entity class for entity RCHR_Emp_Loanlines (stored in table RCHR_Emp_Loanlines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Emp_Loanlines extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Emp_Loanlines";
    public static final String ENTITY_NAME = "RCHR_Emp_Loanlines";
    ...
    public static final String PROPERTY_LOANSCHEDULE = "loanSchedule";
    ...
    public static final String PROPERTY_CUMULATIVEAMOUNT = "cumulativeAmount";
    public static final String PROPERTY_MANUAL = "manual";
    public static final String PROPERTY_PAID = "paid";

    public RCHR_Emp_Loanlines() {
    ...
    public RCHR_Emp_Loan getLoanSchedule() {
        return (RCHR_Emp_Loan) get(PROPERTY_LOANSCHEDULE);
    }

    public void setLoanSchedule(RCHR_Emp_Loan loanSchedule) {
        set(PROPERTY_LOANSCHEDULE, loanSchedule);
    }
    ...
    public BigDecimal getCumulativeAmount() {
        return (BigDecimal) get(PROPERTY_CUMULATIVEAMOUNT);
    }

    public void setCumulativeAmount(BigDecimal cumulativeAmount) {
        set(PROPERTY_CUMULATIVEAMOUNT, cumulativeAmount);
    }
