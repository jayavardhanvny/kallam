...
/**
 * Entity class for entity RCHR_LossOfPay (stored in table RCHR_LossOfPay).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrLossOfPay extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_LossOfPay";
    public static final String ENTITY_NAME = "RCHR_LossOfPay";
    ...
    public BigDecimal getNoOfLeaves() {
        return (BigDecimal) get(PROPERTY_NOOFLEAVES);
    }
