...
/**
 * Entity class for entity RCHR_Loan_Type (stored in table RCHR_Loan_Type).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Loan_Type extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Loan_Type";
    public static final String ENTITY_NAME = "RCHR_Loan_Type";
    ...
    public Long getFromDate() {
        return (Long) get(PROPERTY_FROMDATE);
    }
    ...
    public Long getToDate() {
        return (Long) get(PROPERTY_TODATE);
    }
