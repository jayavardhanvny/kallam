...
/**
 * Entity class for entity RCHR_RoomRentLines (stored in table RCHR_RoomRentLines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrRoomRentLines extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_RoomRentLines";
    public static final String ENTITY_NAME = "RCHR_RoomRentLines";
    ...
    public static final String PROPERTY_RCHRROOMRENT = "rchrRoomrent";
    ...
    public RchrRoomrent getRchrRoomrent() {
        return (RchrRoomrent) get(PROPERTY_RCHRROOMRENT);
    }

    public void setRchrRoomrent(RchrRoomrent rchrRoomrent) {
        set(PROPERTY_RCHRROOMRENT, rchrRoomrent);
    }
