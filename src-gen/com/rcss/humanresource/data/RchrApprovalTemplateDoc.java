...
/**
 * Entity class for entity RCHR_ApprovalTemplateDoc (stored in table RCHR_ApprovalTemplateDoc).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrApprovalTemplateDoc extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_ApprovalTemplateDoc";
    public static final String ENTITY_NAME = "RCHR_ApprovalTemplateDoc";
    ...
    public RchrApprovalTemplateDoc() {
