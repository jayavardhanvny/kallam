...
/**
 * Entity class for entity Rchr_Attendance_To_Line (stored in table Rchr_Attendance_To_Line).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrAttendanceToLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rchr_Attendance_To_Line";
    public static final String ENTITY_NAME = "Rchr_Attendance_To_Line";
    ...
    public static final String PROPERTY_RCHRATTENDANCETIMEOFF = "rchrAttendanceTimeoff";
    ...
    public RchrAttendanceTimeoff getRchrAttendanceTimeoff() {
        return (RchrAttendanceTimeoff) get(PROPERTY_RCHRATTENDANCETIMEOFF);
    }

    public void setRchrAttendanceTimeoff(RchrAttendanceTimeoff rchrAttendanceTimeoff) {
        set(PROPERTY_RCHRATTENDANCETIMEOFF, rchrAttendanceTimeoff);
    }
