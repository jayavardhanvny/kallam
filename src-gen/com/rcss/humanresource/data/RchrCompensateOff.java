...
/**
 * Entity class for entity RCHR_CompensateOff (stored in table RCHR_CompensateOff).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrCompensateOff extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_CompensateOff";
    public static final String ENTITY_NAME = "RCHR_CompensateOff";
    ...
    public static final String PROPERTY_EXPRIYDATE = "expriydate";
    public static final String PROPERTY_ALERTSTATUS = "alertStatus";
    public static final String PROPERTY_ACURALDATE = "acuraldate";
    ...
    public Date getExpriydate() {
        return (Date) get(PROPERTY_EXPRIYDATE);
    }

    public void setExpriydate(Date expriydate) {
        set(PROPERTY_EXPRIYDATE, expriydate);
    }
    ...
    public Date getAcuraldate() {
        return (Date) get(PROPERTY_ACURALDATE);
    }

    public void setAcuraldate(Date acuraldate) {
        set(PROPERTY_ACURALDATE, acuraldate);
    }
