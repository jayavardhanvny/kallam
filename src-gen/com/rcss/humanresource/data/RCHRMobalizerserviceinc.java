...
/**
 * Entity class for entity RCHR_Mobalizerserviceinc (stored in table RCHR_Mobalizerserviceinc).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHRMobalizerserviceinc extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Mobalizerserviceinc";
    public static final String ENTITY_NAME = "RCHR_Mobalizerserviceinc";
    ...
    public static final String PROPERTY_GETINCENTIVE = "getincentive";
    public static final String PROPERTY_RCHRMOBALIZERINCLINESLIST = "rCHRMobalizerinclinesList";

    public RCHRMobalizerserviceinc() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_GETINCENTIVE, false);
    ...
    public Boolean isGetincentive() {
        return (Boolean) get(PROPERTY_GETINCENTIVE);
    }

    public void setGetincentive(Boolean getincentive) {
        set(PROPERTY_GETINCENTIVE, getincentive);
    }
