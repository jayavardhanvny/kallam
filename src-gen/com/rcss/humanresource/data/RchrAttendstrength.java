...
/**
 * Entity class for entity Rchr_Attendstrength (stored in table Rchr_Attendstrength).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RchrAttendstrength extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Rchr_Attendstrength";
    public static final String ENTITY_NAME = "Rchr_Attendstrength";
