...
/**
 * Entity class for entity RCHR_Appliances (stored in table RCHR_Appliances).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_Appliances extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_Appliances";
    public static final String ENTITY_NAME = "RCHR_Appliances";
