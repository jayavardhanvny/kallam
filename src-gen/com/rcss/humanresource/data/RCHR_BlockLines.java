...
/**
 * Entity class for entity RCHR_BlockLines (stored in table RCHR_BlockLines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class RCHR_BlockLines extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "RCHR_BlockLines";
    public static final String ENTITY_NAME = "RCHR_BlockLines";
    ...
    public String getFloor() {
        return (String) get(PROPERTY_FLOOR);
    }

    public void setFloor(String floor) {
        set(PROPERTY_FLOOR, floor);
    }

    public String getRooms() {
        return (String) get(PROPERTY_ROOMS);
    }

    public void setRooms(String rooms) {
        set(PROPERTY_ROOMS, rooms);
    }
