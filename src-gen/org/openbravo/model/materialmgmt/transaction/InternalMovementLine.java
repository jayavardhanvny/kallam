...
public class InternalMovementLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_EPCGUNITPRICE = "epcgUnitprice";
    public static final String PROPERTY_EPCGLINETOTAL = "epcgLinetotal";
    ...
    public InternalMovementLine() {
        ...
        setDefaultValue(PROPERTY_EPCGNOOFPACKS, new BigDecimal(0));
        setDefaultValue(PROPERTY_EPCGUNITPRICE, new BigDecimal(0));
        setDefaultValue(PROPERTY_EPCGLINETOTAL, new BigDecimal(0));
    ...
    public BigDecimal getEpcgNoofpacks() {
        return (BigDecimal) get(PROPERTY_EPCGNOOFPACKS);
    }

    public void setEpcgNoofpacks(BigDecimal epcgNoofpacks) {
        set(PROPERTY_EPCGNOOFPACKS, epcgNoofpacks);
    }

    public BigDecimal getEpcgUnitprice() {
        return (BigDecimal) get(PROPERTY_EPCGUNITPRICE);
    }

    public void setEpcgUnitprice(BigDecimal epcgUnitprice) {
        set(PROPERTY_EPCGUNITPRICE, epcgUnitprice);
    }

    public BigDecimal getEpcgLinetotal() {
        return (BigDecimal) get(PROPERTY_EPCGLINETOTAL);
    }

    public void setEpcgLinetotal(BigDecimal epcgLinetotal) {
        set(PROPERTY_EPCGLINETOTAL, epcgLinetotal);
    }
    ...
    public BigDecimal getEpcgTarewt() {
        return (BigDecimal) get(PROPERTY_EPCGTAREWT);
    }

    public void setEpcgTarewt(BigDecimal epcgTarewt) {
        set(PROPERTY_EPCGTAREWT, epcgTarewt);
    }

    public BigDecimal getEpcgGrosswt() {
        return (BigDecimal) get(PROPERTY_EPCGGROSSWT);
    }

    public void setEpcgGrosswt(BigDecimal epcgGrosswt) {
        set(PROPERTY_EPCGGROSSWT, epcgGrosswt);
    }

    public BigDecimal getEpcgNetwt() {
        return (BigDecimal) get(PROPERTY_EPCGNETWT);
    }

    public void setEpcgNetwt(BigDecimal epcgNetwt) {
