...
public class Requisition extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_RCOBDELIVERYDATE = "rcobDeliverydate";
    public static final String PROPERTY_RCOBINDENTDATE = "rcobIndentdate";
    ...
    public Date getRcobDeliverydate() {
        return (Date) get(PROPERTY_RCOBDELIVERYDATE);
    }

    public void setRcobDeliverydate(Date rcobDeliverydate) {
        set(PROPERTY_RCOBDELIVERYDATE, rcobDeliverydate);
    }

    public Date getRcobIndentdate() {
        return (Date) get(PROPERTY_RCOBINDENTDATE);
    }

    public void setRcobIndentdate(Date rcobIndentdate) {
        set(PROPERTY_RCOBINDENTDATE, rcobIndentdate);
    }
