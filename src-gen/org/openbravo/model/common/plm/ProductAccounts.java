...
public class ProductAccounts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PRASSET = "prasset";
    public static final String PROPERTY_PREXPENSE = "prexpense";
    public static final String PROPERTY_PRWIP = "prwip";
    ...
    public AccountingCombination getPrasset() {
        return (AccountingCombination) get(PROPERTY_PRASSET);
    }

    public void setPrasset(AccountingCombination prasset) {
        set(PROPERTY_PRASSET, prasset);
    }

    public AccountingCombination getPrexpense() {
        return (AccountingCombination) get(PROPERTY_PREXPENSE);
    }

    public void setPrexpense(AccountingCombination prexpense) {
        set(PROPERTY_PREXPENSE, prexpense);
    }

    public AccountingCombination getPrwip() {
        return (AccountingCombination) get(PROPERTY_PRWIP);
    }

    public void setPrwip(AccountingCombination prwip) {
        set(PROPERTY_PRWIP, prwip);
    }
