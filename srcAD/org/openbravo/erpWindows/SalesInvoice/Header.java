  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setSessionId(vars.getSessionValue("#AD_Session_ID"));
      ...
      if (command.contains("17B03F4D1F1E4184A8245B6168928C48")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("17B03F4D1F1E4184A8245B6168928C48");
      ...
      if (securedProcess && command.contains("17B03F4D1F1E4184A8245B6168928C48")) {
        classInfo.type = "P";
        classInfo.id = "17B03F4D1F1E4184A8245B6168928C48";
      }
...
String stradTableId = "318";
    ...
    } else if (vars.commandIn("BUTTONEM_Rcfr_Calcdistcosth17B03F4D1F1E4184A8245B6168928C48")) {
        vars.setSessionValue("button17B03F4D1F1E4184A8245B6168928C48.stremRcfrCalcdistcosth", vars.getStringParameter("inpemRcfrCalcdistcosth"));
        vars.setSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button17B03F4D1F1E4184A8245B6168928C48.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "17B03F4D1F1E4184A8245B6168928C48", request.getServletPath());
      } else if (vars.commandIn("BUTTON17B03F4D1F1E4184A8245B6168928C48")) {
        String strC_Invoice_ID = vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID", "");
        String stremRcfrCalcdistcosth = vars.getSessionValue("button17B03F4D1F1E4184A8245B6168928C48.stremRcfrCalcdistcosth");
        String strProcessing = vars.getSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strProcessing");
        String strOrg = vars.getSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strOrg");
        String strClient = vars.getSessionValue("button17B03F4D1F1E4184A8245B6168928C48.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Rcfr_Calcdistcosth17B03F4D1F1E4184A8245B6168928C48(response, vars, strC_Invoice_ID, stremRcfrCalcdistcosth, strProcessing);
        }
    ...
    } else if (vars.commandIn("SAVE_BUTTONEM_Rcfr_Calcdistcosth17B03F4D1F1E4184A8245B6168928C48")) {
        String strC_Invoice_ID = vars.getGlobalVariable("inpKey", windowId + "|C_Invoice_ID", "");
        
        ProcessBundle pb = new ProcessBundle("17B03F4D1F1E4184A8245B6168928C48", vars).init(this);
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpcInvoiceId", "grid", "../com.rcss.humanresource/erpCommon/ad_reports/ReportSalesInvoice.pdf", "N".equals("Y"), "SalesInvoice", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(HeaderData.selectDef0445FEDA79A747C48A7B3EF852D176DC(this, Utility.getContext(this, vars, "#AD_Org_ID", windowId), Utility.getContext(this, vars, "AD_Role_ID", "167"), Utility.getContext(this, vars, "#AD_Client_ID", windowId)), Utility.getDefault(this, vars, "LastCalculatedOnDate", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Finaldest", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Printtype", "Standard Invoice", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Usdrate", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Withholding_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Withholdingamount", "", "167", "", dataField), Utility.getDefault(this, vars, "Taxdate", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Edexempt", "30/2004 CENTRAL EXCISE", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Invoicetype", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Epcgone", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Inspector", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Agent", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Lcno", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Lrno", "", "167", "", dataField), Utility.getDefault(this, vars, "DaysTillDue", "0", "167", "0", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "167", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "167", "", dataField), "Y", Utility.getDefault(this, vars, "Created", "", "167", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField), HeaderData.selectDef3489_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField), HeaderData.selectDef3491_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "DocumentNo", "", "167", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "0", "167", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "167", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "167", "N", dataField))), Utility.getDefault(this, vars, "Processing", "", "167", "N", dataField), Utility.getDefault(this, vars, "Processed", "", "167", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "167", "", dataField), HeaderData.selectDef3499_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "167", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "167", "0", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "167", "0", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "167", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField), HeaderData.selectDef3510_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Rcfr_Ratetype", "", "167", "", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "167", "N", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Description", "", "167", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "@#Date@", "167", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "167", "", dataField), Utility.getDefault(this, vars, "POReference", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "167", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Locdelivery", "", "167", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "P", "167", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "167", "", dataField), HeaderData.selectDef4247_4(this, Utility.getDefault(this, vars, "C_Order_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "DateOrdered", "", "167", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "167", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "167", "N", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "167", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "167", "N", dataField))), Utility.getDefault(this, vars, "EM_Epcg_Lcdate", "", "167", "", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "167", "N", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Domestictype", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Exciseno", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_APRM_Addpayment", "Y", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Portdischarge", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Transname", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Remarks", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Rcfr_Freightpaid", "0", "167", "0", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "167", "N", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Dispatchto", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "167", "N", dataField))), Utility.getDefault(this, vars, "EM_Epcg_Dispatchfrom", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Portload", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Rcfr_Insuranceh", "", "167", "0", dataField), Utility.getDefault(this, vars, "EM_Rcfr_Calcdistcosth", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Exporttype", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Rcfr_Freighth", "", "167", "0", dataField), Utility.getDefault(this, vars, "Finalsettlement", "", "167", "", dataField), Utility.getDefault(this, vars, "Daysoutstanding", "", "167", "", dataField), Utility.getDefault(this, vars, "Percentageoverdue", "", "167", "", dataField), Utility.getDefault(this, vars, "Totalpaid", "0", "167", "0", dataField), Utility.getDefault(this, vars, "C_Bp_Bankaccount_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_RCOB_Commission", "0", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Formtypeno", "", "167", "", dataField), Utility.getDefault(this, vars, "OutstandingAmt", "0", "167", "0", dataField), Utility.getDefault(this, vars, "EM_Epcg_Poincval", "0", "167", "", dataField), Utility.getDefault(this, vars, "DueAmt", "0", "167", "0", dataField), Utility.getDefault(this, vars, "EM_Epcg_Superintendent", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Areno", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_RCOB_Isinvoicecreated", "N", "167", "N", dataField), Utility.getDefault(this, vars, "Ispaid", "N", "167", "N", dataField), Utility.getDefault(this, vars, "UpdatePaymentMonitor", "N", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Type", "", "167", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Calculate_Promotions", "", "167", "N", dataField), Utility.getDefault(this, vars, "EM_Epcg_Waybillno", "", "167", "", dataField), Utility.getDefault(this, vars, "EM_Epcg_Check", "", "167", "N", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoiceId", "", "../com.rcss.humanresource/erpCommon/ad_reports/ReportSalesInvoice.pdf", "N".equals("Y"), "SalesInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Invoice_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "EM_Epcg_Printtype", "A18A8E4949BF49F788503B4B9FF74D68", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emEpcgPrinttype"):dataField.getField("emEpcgPrinttype")));
xmlDocument.setData("reportEM_Epcg_Printtype","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("EM_Rcfr_Calcdistcosth_BTNname", Utility.getButtonName(this, vars, "17912D2D8DFE4E1A8640C9B964C2CA30", "EM_Rcfr_Calcdistcosth_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Rcfr_Calcdistcosth = org.openbravo.erpCommon.utility.Utility.isModalProcess("17B03F4D1F1E4184A8245B6168928C48"); 
xmlDocument.setParameter("EM_Rcfr_Calcdistcosth_Modal", modalEM_Rcfr_Calcdistcosth?"true":"false");
...
xmlDocument.setParameter("array", dact.toString());
    ...
    void printPageButtonEM_Rcfr_Calcdistcosth17B03F4D1F1E4184A8245B6168928C48(HttpServletResponse response, VariablesSecureApp vars, String strC_Invoice_ID, String stremRcfrCalcdistcosth, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 17B03F4D1F1E4184A8245B6168928C48");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Rcfr_Calcdistcosth17B03F4D1F1E4184A8245B6168928C48", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Invoice_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "17B03F4D1F1E4184A8245B6168928C48");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
