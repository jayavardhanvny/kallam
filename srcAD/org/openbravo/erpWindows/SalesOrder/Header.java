...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpcOrderId", "grid", "../com.rcss.humanresource/erpCommon/ad_reports/ReportSalesOrder.pdf", "N".equals("Y"), "SalesOrder", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
comboTableData = new ComboTableData(vars, this, "17", "EM_Epcg_Ratetype", "74D3C7DF005C4D03935CEE28256DC187", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emEpcgRatetype"):dataField.getField("emEpcgRatetype")));
xmlDocument.setData("reportEM_Epcg_Ratetype","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "EM_Epcg_Ordertype", "36DED13CD40A4041B87B6A7FE14E4B62", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emEpcgOrdertype"):dataField.getField("emEpcgOrdertype")));
xmlDocument.setData("reportEM_Epcg_Ordertype","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("EM_Epcg_Copylines_BTNname", Utility.getButtonName(this, vars, "7058864730334C948EC6BB9B22B4D6F3", "EM_Epcg_Copylines_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Epcg_Copylines = org.openbravo.erpCommon.utility.Utility.isModalProcess("7CFC56537A1F44C1A4A63622679E72D5"); 
xmlDocument.setParameter("EM_Epcg_Copylines_Modal", modalEM_Epcg_Copylines?"true":"false");
xmlDocument.setParameter("EM_Epcg_Proforma_BTNname", Utility.getButtonName(this, vars, "47DA47590EDE442CB3555104BFBB0BA1", "EM_Epcg_Proforma_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Epcg_Proforma = org.openbravo.erpCommon.utility.Utility.isModalProcess("2D9920B6A48E48D18A0B200A3B4C7EC5"); 
xmlDocument.setParameter("EM_Epcg_Proforma_Modal", modalEM_Epcg_Proforma?"true":"false");
