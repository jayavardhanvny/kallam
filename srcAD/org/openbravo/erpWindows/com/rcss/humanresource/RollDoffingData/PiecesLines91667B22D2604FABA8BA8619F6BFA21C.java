...
public class PiecesLines91667B22D2604FABA8BA8619F6BFA21C extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|Rchr_Loomsdata_ID", strPRchr_Loomsdata_ID);
      vars.setSessionValue("090E02F9D0E0474D826F391925578210|Roll Doffing Data.view", "EDIT");
...
vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPRchr_Loomsdata_ID) throws IOException,ServletException {
      ...
      RollDoffingData090E02F9D0E0474D826F391925578210Data[] data = RollDoffingData090E02F9D0E0474D826F391925578210Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|Rchr_Loomsdata_ID", data[0].rchrLoomsdataId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
  ...
  private String getParentID(VariablesSecureApp vars, String strRchr_Loomsdata_Lines_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Rchr_Loomsdata_Lines_ID", data[0].getField("rchrLoomsdataLinesId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPRchr_Loomsdata_ID, String strRchr_Loomsdata_Lines_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/RollDoffingData/PiecesLines91667B22D2604FABA8BA8619F6BFA21C_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "PiecesLines91667B22D2604FABA8BA8619F6BFA21C", false, "document.frmMain.inprchrLoomsdataLinesId", "grid", "..", "".equals("Y"), "RollDoffingData", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PiecesLines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", "RollDoffingData", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", PiecesLines91667B22D2604FABA8BA8619F6BFA21CData.selectParent(this, strPRchr_Loomsdata_ID));
    else xmlDocument.setParameter("parent", PiecesLines91667B22D2604FABA8BA8619F6BFA21CData.selectParentTrl(this, strPRchr_Loomsdata_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Loomsdata_Lines_ID, String strPRchr_Loomsdata_ID, TableSQLData tableSQL)
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/RollDoffingData/PiecesLines91667B22D2604FABA8BA8619F6BFA21C_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/RollDoffingData/PiecesLines91667B22D2604FABA8BA8619F6BFA21C_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PiecesLines91667B22D2604FABA8BA8619F6BFA21C", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLoomsdataLinesId", "", "..", "".equals("Y"), "RollDoffingData", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Loomsdata_Lines_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PiecesLines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", "RollDoffingData", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PiecesLines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", strReplaceWith);
