...
public class MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamRchr_Mobalizer_ID", tabId + "|paramRchr_Mobalizer_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Mobalizerserviceinc_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.view", strView);
        }
      }
      ...
      String strRchr_Mobalizerserviceinc_ID = vars.getGlobalVariable("inprchrMobalizerserviceincId", windowId + "|Rchr_Mobalizerserviceinc_ID", "");
      vars.setSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Mobalizerserviceinc_ID");
      ...
      String strRchr_Mobalizerserviceinc_ID = vars.getRequiredStringParameter("inprchrMobalizerserviceincId");
      //MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.delete(this, strRchr_Mobalizerserviceinc_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data data = new MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data();
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strRchr_Mobalizerserviceinc_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobalizerServiceIncentive/MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98", false, "document.frmMain.inprchrMobalizerserviceincId", "grid", "..", "".equals("Y"), "MobalizerServiceIncentive", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", "MobalizerServiceIncentive", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Mobalizerserviceinc_ID, TableSQLData tableSQL)
    ...
    MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strRchr_Mobalizerserviceinc_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.set(Utility.getDefault(this, vars, "Createdby", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField), MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.selectDef04D6D4FAD15D4741808369C1A9E0614B_0(this, Utility.getDefault(this, vars, "Createdby", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField), Utility.getDefault(this, vars, "Rchr_Attd_Process_ID", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField), MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.selectDef3B88C5261B4C447C9A80049E1BC40890_1(this, Utility.getDefault(this, vars, "Updatedby", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField)), "Y", "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField), Utility.getDefault(this, vars, "Getincentive", "N", "A8FEDA7A55EF4AA29277FEA47080B221", "N", dataField), Utility.getDefault(this, vars, "Rchr_Mobalizer_ID", "", "A8FEDA7A55EF4AA29277FEA47080B221", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobalizerServiceIncentive/MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobalizerServiceIncentive/MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrMobalizerserviceincId", "", "..", "".equals("Y"), "MobalizerServiceIncentive", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Mobalizerserviceinc_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", "MobalizerServiceIncentive", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data.getCurrentDBTimestamp(this, data.rchrMobalizerserviceincId).equals(
  ...
  public String getServletInfo() {
    return "Servlet MobalizerServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98. This Servlet was made by Wad constructor";
