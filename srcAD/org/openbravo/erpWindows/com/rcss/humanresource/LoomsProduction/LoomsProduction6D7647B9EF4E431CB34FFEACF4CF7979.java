...
package org.openbravo.erpWindows.com.rcss.humanresource.LoomsProduction;
...
public class LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.class);
  
  private static final String windowId = "3A41A84213E9451D975EF7A935825969";
  private static final String tabId = "6D7647B9EF4E431CB34FFEACF4CF7979";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamLoomsenddate_f", tabId + "|paramLoomsenddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Loomsdata_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.view", strView);
        }
      }
      ...
      String strRchr_Loomsdata_ID = vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID", "");
      vars.setSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Loomsdata_ID");
      ...
      String strRchr_Loomsdata_ID = vars.getRequiredStringParameter("inprchrLoomsdataId");
      //LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.delete(this, strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data data = new LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data();
    ServletException ex = null;
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.loomsstartdate = vars.getRequiredStringParameter("inploomsstartdate");     data.fromtime = vars.getStringParameter("inpfromtime");     data.rcplLoomId = vars.getRequiredStringParameter("inprcplLoomId");     data.rcplLoomIdr = vars.getStringParameter("inprcplLoomId_R");     data.rchrBeamLinesId = vars.getStringParameter("inprchrBeamLinesId");     data.loomsenddate = vars.getStringParameter("inploomsenddate");    try {   data.beamlength = vars.getRequiredNumericParameter("inpbeamlength");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grossWeight = vars.getRequiredNumericParameter("inpgrossWeight");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.tareWeight = vars.getRequiredNumericParameter("inptareWeight");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.netweight = vars.getRequiredNumericParameter("inpnetweight");  } catch (ServletException paramEx) { ex = paramEx; }     data.status = vars.getStringParameter("inpstatus");     data.statusr = vars.getStringParameter("inpstatus_R");     data.process = vars.getStringParameter("inpprocess");     data.rchrBeamId = vars.getRequiredStringParameter("inprchrBeamId");     data.rchrBeamIdr = vars.getStringParameter("inprchrBeamId_R");     data.rchrJobcardId = vars.getStringParameter("inprchrJobcardId");     data.rchrJobcardIdr = vars.getStringParameter("inprchrJobcardId_R");     data.rchrQualitystandardId = vars.getStringParameter("inprchrQualitystandardId");     data.rchrQualitystandardIdr = vars.getStringParameter("inprchrQualitystandardId_R");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.rchrLoomsdataId = vars.getRequestGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID"); 
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Rchr_Loomsdata_ID", data[0].getField("rchrLoomsdataId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data[] data = LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inprchrLoomsdataId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LoomsProduction/LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979", false, "document.frmMain.inprchrLoomsdataId", "grid", "..", "".equals("Y"), "LoomsProduction", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", "LoomsProduction", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Loomsdata_ID, TableSQLData tableSQL)
    ...
    LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data[] data=null;
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.set(Utility.getDefault(this, vars, "Rchr_Beam_Lines_ID", "", "3A41A84213E9451D975EF7A935825969", "", dataField), "Y", Utility.getDefault(this, vars, "Loomsenddate", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Tare_Weight", "", "3A41A84213E9451D975EF7A935825969", "0", dataField), Utility.getDefault(this, vars, "Fromtime", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Rchr_Qualitystandard_ID", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "3A41A84213E9451D975EF7A935825969", "", dataField), LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.selectDef7DF2A41E72604F95B124A78ED6E56111_0(this, Utility.getDefault(this, vars, "Updatedby", "", "3A41A84213E9451D975EF7A935825969", "", dataField)), Utility.getDefault(this, vars, "Netweight", "", "3A41A84213E9451D975EF7A935825969", "0", dataField), "", Utility.getDefault(this, vars, "Beamlength", "", "3A41A84213E9451D975EF7A935825969", "0", dataField), Utility.getDefault(this, vars, "Rcpl_Loom_ID", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "3A41A84213E9451D975EF7A935825969", "", dataField), LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.selectDefAD544C3B933744589E62441C68E44BBE_1(this, Utility.getDefault(this, vars, "Createdby", "", "3A41A84213E9451D975EF7A935825969", "", dataField)), Utility.getDefault(this, vars, "Status", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Rchr_Jobcard_ID", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Loomsstartdate", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Rchr_Beam_ID", "", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "3A41A84213E9451D975EF7A935825969", "", dataField), Utility.getDefault(this, vars, "Process", "N", "3A41A84213E9451D975EF7A935825969", "N", dataField), Utility.getDefault(this, vars, "Gross_Weight", "", "3A41A84213E9451D975EF7A935825969", "0", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LoomsProduction/LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LoomsProduction/LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLoomsdataId", "", "..", "".equals("Y"), "LoomsProduction", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Loomsdata_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", "LoomsProduction", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", strReplaceWith);
...
comboTableData = new ComboTableData(vars, this, "19", "Rcpl_Loom_ID", "", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
comboTableData = null;
xmlDocument.setParameter("Process_BTNname", Utility.getButtonName(this, vars, "99754C025EB34503B31F7B1441832206", "Process_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcess = org.openbravo.erpCommon.utility.Utility.isModalProcess("A49580DFBA994334957B0E398916E97F"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979Data.getCurrentDBTimestamp(this, data.rchrLoomsdataId).equals(
  ...
  public String getServletInfo() {
    return "Servlet LoomsProduction6D7647B9EF4E431CB34FFEACF4CF7979. This Servlet was made by Wad constructor";
