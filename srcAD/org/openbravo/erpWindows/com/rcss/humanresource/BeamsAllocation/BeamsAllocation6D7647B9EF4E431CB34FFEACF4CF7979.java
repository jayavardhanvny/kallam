...
package org.openbravo.erpWindows.com.rcss.humanresource.BeamsAllocation;
...
public class BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamLoomsenddate_f", tabId + "|paramLoomsenddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Loomsdata_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.view", strView);
        }
      }
      ...
      String strRchr_Loomsdata_ID = vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID", "");
      vars.setSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Loomsdata_ID");
      ...
      String strRchr_Loomsdata_ID = vars.getRequiredStringParameter("inprchrLoomsdataId");
      //BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data.delete(this, strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data[] data = BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inprchrLoomsdataId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/BeamsAllocation/BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979", false, "document.frmMain.inprchrLoomsdataId", "grid", "..", "".equals("Y"), "BeamsAllocation", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", "BeamsAllocation", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Loomsdata_ID, TableSQLData tableSQL)
    ...
    BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data[] data=null;
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/BeamsAllocation/BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/BeamsAllocation/BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLoomsdataId", "", "..", "".equals("Y"), "BeamsAllocation", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Loomsdata_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", "BeamsAllocation", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979Data.getCurrentDBTimestamp(this, data.rchrLoomsdataId).equals(
  ...
  public String getServletInfo() {
    return "Servlet BeamsAllocation6D7647B9EF4E431CB34FFEACF4CF7979. This Servlet was made by Wad constructor";
