...
String strParamStartdate_f = vars.getSessionValue(tabId + "|paramStartdate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/EmployeeOverTime/EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "EmployeeOverTimeE6A64D5828994C469282D819A0CA338E", false, "document.frmMain.inprchrOvertimeheaderId", "grid", "..", "".equals("Y"), "EmployeeOverTime", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_Relation.html", "EmployeeOverTime", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
String strParamStartdate_f = vars.getSessionValue(tabId + "|paramStartdate_f");
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/EmployeeOverTime/EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/EmployeeOverTime/EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "EmployeeOverTimeE6A64D5828994C469282D819A0CA338E", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrOvertimeheaderId", "", "..", "".equals("Y"), "EmployeeOverTime", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Overtimeheader_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_Relation.html", "EmployeeOverTime", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "EmployeeOverTimeE6A64D5828994C469282D819A0CA338E_Relation.html", strReplaceWith);
