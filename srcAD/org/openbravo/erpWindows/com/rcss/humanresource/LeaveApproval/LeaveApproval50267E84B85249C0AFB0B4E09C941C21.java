...
package org.openbravo.erpWindows.com.rcss.humanresource.LeaveApproval;
...
public class LeaveApproval50267E84B85249C0AFB0B4E09C941C21 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(LeaveApproval50267E84B85249C0AFB0B4E09C941C21.class);
  
  private static final String windowId = "117A7FA07E714F0EA01A03060138E86F";
  private static final String tabId = "50267E84B85249C0AFB0B4E09C941C21";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamTodate_f", tabId + "|paramTodate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Leaverequisition_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.view", strView);
        }
      }
      ...
      String strRchr_Leaverequisition_ID = vars.getGlobalVariable("inprchrLeaverequisitionId", windowId + "|Rchr_Leaverequisition_ID", "");
      vars.setSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|LeaveApproval50267E84B85249C0AFB0B4E09C941C21.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Leaverequisition_ID");
      ...
      String strRchr_Leaverequisition_ID = vars.getRequiredStringParameter("inprchrLeaverequisitionId");
      //LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.delete(this, strRchr_Leaverequisition_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data data = new LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data();
    ServletException ex = null;
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.rchrEmployeeId = vars.getStringParameter("inprchrEmployeeId");     data.rchrEmployeeIdr = vars.getStringParameter("inprchrEmployeeId_R");     data.employeetype = vars.getStringParameter("inpemployeetype");     data.employeetyper = vars.getStringParameter("inpemployeetype_R");     data.rchrLeavetypeId = vars.getStringParameter("inprchrLeavetypeId");     data.requisitiondate = vars.getRequiredStringParameter("inprequisitiondate");    try {   data.leaveopening = vars.getNumericParameter("inpleaveopening");  } catch (ServletException paramEx) { ex = paramEx; }     data.fromdate = vars.getRequiredStringParameter("inpfromdate");     data.process = vars.getRequiredStringParameter("inpprocess");     data.todate = vars.getRequiredStringParameter("inptodate");    try {   data.noofleaves = vars.getRequiredNumericParameter("inpnoofleaves");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.weekoffleaves = vars.getNumericParameter("inpweekoffleaves");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.lopleaves = vars.getNumericParameter("inplopleaves");  } catch (ServletException paramEx) { ex = paramEx; }     data.reason = vars.getRequiredStringParameter("inpreason");     data.post = vars.getRequiredStringParameter("inppost");     data.rchrLeaverequisitionId = vars.getRequestGlobalVariable("inprchrLeaverequisitionId", windowId + "|Rchr_Leaverequisition_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Rchr_Leaverequisition_ID", data[0].getField("rchrLeaverequisitionId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data[] data = LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inprchrLeaverequisitionId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamTodate_f = vars.getSessionValue(tabId + "|paramTodate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LeaveApproval/LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21", false, "document.frmMain.inprchrLeaverequisitionId", "grid", "..", "".equals("Y"), "LeaveApproval", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Relation.html", "LeaveApproval", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Leaverequisition_ID, TableSQLData tableSQL)
    ...
    LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data[] data=null;
...
String strParamTodate_f = vars.getSessionValue(tabId + "|paramTodate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strRchr_Leaverequisition_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.set(Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Weekoffleaves", "0", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Employeetype", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.selectDef256828AFF94B4E269C8ABC7E6BD91187_0(this, Utility.getDefault(this, vars, "Updatedby", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField)), Utility.getDefault(this, vars, "Rchr_Employee_ID", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Fromdate", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), "Y", "", Utility.getDefault(this, vars, "Rchr_Leavetype_ID", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Reason", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Process", "N", "117A7FA07E714F0EA01A03060138E86F", "N", dataField), Utility.getDefault(this, vars, "Post", "N", "117A7FA07E714F0EA01A03060138E86F", "N", dataField), Utility.getDefault(this, vars, "Requisitiondate", "@#Date@", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Leaveopening", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Lopleaves", "0", "117A7FA07E714F0EA01A03060138E86F", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField), LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.selectDefD709A66F53E74595932046A6970A6689_1(this, Utility.getDefault(this, vars, "Createdby", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField)), Utility.getDefault(this, vars, "Noofleaves", "", "117A7FA07E714F0EA01A03060138E86F", "0", dataField), Utility.getDefault(this, vars, "Todate", "", "117A7FA07E714F0EA01A03060138E86F", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LeaveApproval/LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/LeaveApproval/LeaveApproval50267E84B85249C0AFB0B4E09C941C21_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLeaverequisitionId", "", "..", "".equals("Y"), "LeaveApproval", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Leaverequisition_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Relation.html", "LeaveApproval", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Process_BTNname", Utility.getButtonName(this, vars, "ADA23252287F4DD8B1A40DBB85E73459", "Process_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcess = org.openbravo.erpCommon.utility.Utility.isModalProcess("84143CAAADE74274B0560AFDE28E7156"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "LeaveApproval50267E84B85249C0AFB0B4E09C941C21_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (LeaveApproval50267E84B85249C0AFB0B4E09C941C21Data.getCurrentDBTimestamp(this, data.rchrLeaverequisitionId).equals(
  ...
  public String getServletInfo() {
    return "Servlet LeaveApproval50267E84B85249C0AFB0B4E09C941C21. This Servlet was made by Wad constructor";
