...
package org.openbravo.erpWindows.com.rcss.humanresource.MobilizersServiceIncentive;
...
vars.getRequestGlobalVariable("inpParamRchr_Mobalizer_ID", tabId + "|paramRchr_Mobalizer_ID");
  ...
  private MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Rchr_Mobalizerserviceinc_ID", data[0].getField("rchrMobalizerserviceincId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strRchr_Mobalizerserviceinc_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobilizersServiceIncentive/MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98", false, "document.frmMain.inprchrMobalizerserviceincId", "grid", "..", "".equals("Y"), "MobilizersServiceIncentive", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", "MobilizersServiceIncentive", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Mobalizerserviceinc_ID, TableSQLData tableSQL)
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobilizersServiceIncentive/MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/MobilizersServiceIncentive/MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrMobalizerserviceincId", "", "..", "".equals("Y"), "MobilizersServiceIncentive", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Mobalizerserviceinc_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", "MobilizersServiceIncentive", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "MobilizersServiceIncentiveCF669DCF8AF04688AFCA7B97D84C3E98_Relation.html", strReplaceWith);
