...
public class Lines91667B22D2604FABA8BA8619F6BFA21C extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Lines91667B22D2604FABA8BA8619F6BFA21C.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDocumentno", tabId + "|paramDocumentno");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Loomsdata_Lines_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.view", strView);
        }
      }
      ...
      String strRchr_Loomsdata_Lines_ID = vars.getGlobalVariable("inprchrLoomsdataLinesId", windowId + "|Rchr_Loomsdata_Lines_ID", "");
      vars.setSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.view", "RELATION");
...
vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID");
      ...
      vars.setSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPRchr_Loomsdata_ID = vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Lines91667B22D2604FABA8BA8619F6BFA21C.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Loomsdata_Lines_ID");
      vars.setSessionValue(windowId + "|Rchr_Loomsdata_ID", strPRchr_Loomsdata_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strRchr_Loomsdata_Lines_ID = vars.getRequiredStringParameter("inprchrLoomsdataLinesId");
      //Lines91667B22D2604FABA8BA8619F6BFA21CData data = getEditVariables(vars, strPRchr_Loomsdata_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Lines91667B22D2604FABA8BA8619F6BFA21CData.delete(this, strRchr_Loomsdata_Lines_ID, strPRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strRchr_Loomsdata_Lines_ID) throws ServletException {
    String strPRchr_Loomsdata_ID = Lines91667B22D2604FABA8BA8619F6BFA21CData.selectParentID(this, strRchr_Loomsdata_Lines_ID);
    if (strPRchr_Loomsdata_ID.equals("")) {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPRchr_Loomsdata_ID, String strRchr_Loomsdata_Lines_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Lines91667B22D2604FABA8BA8619F6BFA21C_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C", false, "document.frmMain.inprchrLoomsdataLinesId", "grid", "..", "".equals("Y"), "Doffing", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", "Doffing", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Lines91667B22D2604FABA8BA8619F6BFA21CData.selectParent(this, vars.getLanguage(), strPRchr_Loomsdata_ID));
    else xmlDocument.setParameter("parent", Lines91667B22D2604FABA8BA8619F6BFA21CData.selectParentTrl(this, vars.getLanguage(), strPRchr_Loomsdata_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Loomsdata_Lines_ID, String strPRchr_Loomsdata_ID, TableSQLData tableSQL)
    ...
    Lines91667B22D2604FABA8BA8619F6BFA21CData[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Lines91667B22D2604FABA8BA8619F6BFA21CData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPRchr_Loomsdata_ID, strRchr_Loomsdata_Lines_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Lines91667B22D2604FABA8BA8619F6BFA21CData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Lines91667B22D2604FABA8BA8619F6BFA21CData.set(strPRchr_Loomsdata_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Islast", "N", "5C2AA29FE6E24406AD35C90DED42525D", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Lines91667B22D2604FABA8BA8619F6BFA21CData.selectDef1BE036C127804F0C8441690D8F62DA58(this, strPRchr_Loomsdata_ID), Utility.getDefault(this, vars, "Loomsenddate", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), "", Utility.getDefault(this, vars, "Updatedby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Lines91667B22D2604FABA8BA8619F6BFA21CData.selectDef7DA38B8B25E04FB39635EDB24658FA8A_0(this, Utility.getDefault(this, vars, "Updatedby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField)), "Y", Utility.getDefault(this, vars, "Complete", "", "5C2AA29FE6E24406AD35C90DED42525D", "N", dataField), Utility.getDefault(this, vars, "Process", "N", "5C2AA29FE6E24406AD35C90DED42525D", "N", dataField), Utility.getDefault(this, vars, "Documentno", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Rchr_Insprolltype_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Totime", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Lines91667B22D2604FABA8BA8619F6BFA21CData.selectDefDBDA3EE3217E435A855300F80348AD4F_1(this, Utility.getDefault(this, vars, "Createdby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField)), Utility.getDefault(this, vars, "Actualmts", "", "5C2AA29FE6E24406AD35C90DED42525D", "0", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Lines91667B22D2604FABA8BA8619F6BFA21C_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Lines91667B22D2604FABA8BA8619F6BFA21C_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLoomsdataLinesId", "", "..", "".equals("Y"), "Doffing", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Loomsdata_Lines_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", "Doffing", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines91667B22D2604FABA8BA8619F6BFA21C_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Lines91667B22D2604FABA8BA8619F6BFA21C_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Lines91667B22D2604FABA8BA8619F6BFA21CData.getCurrentDBTimestamp(this, data.rchrLoomsdataLinesId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Lines91667B22D2604FABA8BA8619F6BFA21C. This Servlet was made by Wad constructor";
