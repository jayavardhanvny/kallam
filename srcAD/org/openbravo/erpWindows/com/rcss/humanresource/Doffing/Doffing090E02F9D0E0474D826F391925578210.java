...
public class Doffing090E02F9D0E0474D826F391925578210 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Doffing090E02F9D0E0474D826F391925578210.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamLoomsenddate_f", tabId + "|paramLoomsenddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRchr_Loomsdata_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.view", strView);
        }
      }
      ...
      String strRchr_Loomsdata_ID = vars.getGlobalVariable("inprchrLoomsdataId", windowId + "|Rchr_Loomsdata_ID", "");
      vars.setSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Doffing090E02F9D0E0474D826F391925578210.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rchr_Loomsdata_ID");
      ...
      String strRchr_Loomsdata_ID = vars.getRequiredStringParameter("inprchrLoomsdataId");
      //Doffing090E02F9D0E0474D826F391925578210Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Doffing090E02F9D0E0474D826F391925578210Data.delete(this, strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Doffing090E02F9D0E0474D826F391925578210_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210", false, "document.frmMain.inprchrLoomsdataId", "grid", "..", "".equals("Y"), "Doffing", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210_Relation.html", "Doffing", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Loomsdata_ID, TableSQLData tableSQL)
    ...
    Doffing090E02F9D0E0474D826F391925578210Data[] data=null;
...
String strParamLoomsenddate_f = vars.getSessionValue(tabId + "|paramLoomsenddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Doffing090E02F9D0E0474D826F391925578210Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strRchr_Loomsdata_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Doffing090E02F9D0E0474D826F391925578210Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Doffing090E02F9D0E0474D826F391925578210Data.set(Utility.getDefault(this, vars, "Rchr_Beam_Lines_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), "Y", Utility.getDefault(this, vars, "Loomsenddate", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Tare_Weight", "", "5C2AA29FE6E24406AD35C90DED42525D", "0", dataField), Utility.getDefault(this, vars, "Fromtime", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Rchr_Qualitystandard_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Doffing090E02F9D0E0474D826F391925578210Data.selectDef7DF2A41E72604F95B124A78ED6E56111_0(this, Utility.getDefault(this, vars, "Updatedby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField)), Utility.getDefault(this, vars, "Netweight", "", "5C2AA29FE6E24406AD35C90DED42525D", "0", dataField), "", Utility.getDefault(this, vars, "Beamlength", "", "5C2AA29FE6E24406AD35C90DED42525D", "0", dataField), Utility.getDefault(this, vars, "Rcpl_Loom_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Doffing090E02F9D0E0474D826F391925578210Data.selectDefAD544C3B933744589E62441C68E44BBE_1(this, Utility.getDefault(this, vars, "Createdby", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField)), Utility.getDefault(this, vars, "Status", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Rchr_Jobcard_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Loomsstartdate", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Rchr_Beam_ID", "", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "5C2AA29FE6E24406AD35C90DED42525D", "", dataField), Utility.getDefault(this, vars, "Process", "N", "5C2AA29FE6E24406AD35C90DED42525D", "N", dataField), Utility.getDefault(this, vars, "Gross_Weight", "", "5C2AA29FE6E24406AD35C90DED42525D", "0", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Doffing090E02F9D0E0474D826F391925578210_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/Doffing/Doffing090E02F9D0E0474D826F391925578210_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrLoomsdataId", "", "..", "".equals("Y"), "Doffing", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Loomsdata_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210_Relation.html", "Doffing", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Doffing090E02F9D0E0474D826F391925578210_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Doffing090E02F9D0E0474D826F391925578210_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Doffing090E02F9D0E0474D826F391925578210Data.getCurrentDBTimestamp(this, data.rchrLoomsdataId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Doffing090E02F9D0E0474D826F391925578210. This Servlet was made by Wad constructor";
