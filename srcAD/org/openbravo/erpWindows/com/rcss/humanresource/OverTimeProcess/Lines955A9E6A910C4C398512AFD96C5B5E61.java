...
vars.getGlobalVariable("inprchrOvertimeheaderId", windowId + "|Rchr_Overtimeheader_ID");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPRchr_Overtimeheader_ID, String strRchr_Overtime_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/Lines955A9E6A910C4C398512AFD96C5B5E61_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines955A9E6A910C4C398512AFD96C5B5E61", false, "document.frmMain.inprchrOvertimeId", "grid", "..", "".equals("Y"), "OverTimeProcess", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines955A9E6A910C4C398512AFD96C5B5E61_Relation.html", "OverTimeProcess", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Overtime_ID, String strPRchr_Overtimeheader_ID, TableSQLData tableSQL)
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/Lines955A9E6A910C4C398512AFD96C5B5E61_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/Lines955A9E6A910C4C398512AFD96C5B5E61_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines955A9E6A910C4C398512AFD96C5B5E61", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrOvertimeId", "", "..", "".equals("Y"), "OverTimeProcess", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Overtime_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines955A9E6A910C4C398512AFD96C5B5E61_Relation.html", "OverTimeProcess", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines955A9E6A910C4C398512AFD96C5B5E61_Relation.html", strReplaceWith);
