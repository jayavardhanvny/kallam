...
vars.getRequestGlobalVariable("inpParamRchr_Overtimeprocess_ID", tabId + "|paramRchr_Overtimeprocess_ID");
  ...
  private OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2FData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Rchr_Overtimeprocess_ID", data[0].getField("rchrOvertimeprocessId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strRchr_Overtimeprocess_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F", false, "document.frmMain.inprchrOvertimeprocessId", "grid", "..", "".equals("Y"), "OverTimeProcess", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_Relation.html", "OverTimeProcess", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRchr_Overtimeprocess_ID, TableSQLData tableSQL)
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/rcss/humanresource/OverTimeProcess/OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprchrOvertimeprocessId", "", "..", "".equals("Y"), "OverTimeProcess", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRchr_Overtimeprocess_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_Relation.html", "OverTimeProcess", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "OverTimeProcess54B9A86AAB3D4943881CEA2E5C5EDC2F_Relation.html", strReplaceWith);
