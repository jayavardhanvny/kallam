...
public class EmployeesA88CE224AC9E4285B9742794796EC056 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(EmployeesA88CE224AC9E4285B9742794796EC056.class);
  
  private static final String windowId = "BA00CD9835D0423193FAB5395377FA71";
  private static final String tabId = "A88CE224AC9E4285B9742794796EC056";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDescription", tabId + "|paramDescription");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRcpl_Emppprocessmanual_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.view", strView);
        }
      }
      ...
      String strRcpl_Emppprocessmanual_ID = vars.getGlobalVariable("inprcplEmppprocessmanualId", windowId + "|Rcpl_Emppprocessmanual_ID", "");
      vars.setSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.view", "RELATION");
...
vars.getGlobalVariable("inprcplPayrollprocessmanualId", windowId + "|Rcpl_Payrollprocessmanual_ID");
      ...
      vars.setSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPRcpl_Payrollprocessmanual_ID = vars.getGlobalVariable("inprcplPayrollprocessmanualId", windowId + "|Rcpl_Payrollprocessmanual_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|EmployeesA88CE224AC9E4285B9742794796EC056.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rcpl_Emppprocessmanual_ID");
      vars.setSessionValue(windowId + "|Rcpl_Payrollprocessmanual_ID", strPRcpl_Payrollprocessmanual_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strRcpl_Emppprocessmanual_ID = vars.getRequiredStringParameter("inprcplEmppprocessmanualId");
      //EmployeesA88CE224AC9E4285B9742794796EC056Data data = getEditVariables(vars, strPRcpl_Payrollprocessmanual_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = EmployeesA88CE224AC9E4285B9742794796EC056Data.delete(this, strRcpl_Emppprocessmanual_ID, strPRcpl_Payrollprocessmanual_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private EmployeesA88CE224AC9E4285B9742794796EC056Data getEditVariables(Connection con, VariablesSecureApp vars, String strPRcpl_Payrollprocessmanual_ID) throws IOException,ServletException {
    EmployeesA88CE224AC9E4285B9742794796EC056Data data = new EmployeesA88CE224AC9E4285B9742794796EC056Data();
    ServletException ex = null;
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.rchrEmployeeId = vars.getStringParameter("inprchrEmployeeId");     data.rchrEmployeeIdr = vars.getStringParameter("inprchrEmployeeId_R");     data.rchrDailyattendId = vars.getStringParameter("inprchrDailyattendId");     data.attddate = vars.getRequiredStringParameter("inpattddate");     data.daytype = vars.getRequiredStringParameter("inpdaytype");     data.daytyper = vars.getStringParameter("inpdaytype_R");     data.process = vars.getStringParameter("inpprocess", "N");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.complete = vars.getStringParameter("inpcomplete");     data.rcplPayrollprocessmanualId = vars.getRequiredStringParameter("inprcplPayrollprocessmanualId");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.description = vars.getRequiredStringParameter("inpdescription");     data.manualpresents = vars.getStringParameter("inpmanualpresents", "N");     data.otprocess = vars.getStringParameter("inpotprocess", "N");     data.punchin = vars.getStringParameter("inppunchin");     data.rcprShiftId = vars.getRequiredStringParameter("inprcprShiftId");     data.rcprShiftIdr = vars.getStringParameter("inprcprShiftId_R");     data.rcplEmppprocessmanualId = vars.getRequestGlobalVariable("inprcplEmppprocessmanualId", windowId + "|Rcpl_Emppprocessmanual_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
  ...
  private String getParentID(VariablesSecureApp vars, String strRcpl_Emppprocessmanual_ID) throws ServletException {
    String strPRcpl_Payrollprocessmanual_ID = EmployeesA88CE224AC9E4285B9742794796EC056Data.selectParentID(this, strRcpl_Emppprocessmanual_ID);
    if (strPRcpl_Payrollprocessmanual_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Rcpl_Emppprocessmanual_ID", data[0].getField("rcplEmppprocessmanualId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPRcpl_Payrollprocessmanual_ID) throws IOException,ServletException {
      EmployeesA88CE224AC9E4285B9742794796EC056Data[] data = EmployeesA88CE224AC9E4285B9742794796EC056Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPRcpl_Payrollprocessmanual_ID, vars.getStringParameter("inprcplEmppprocessmanualId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPRcpl_Payrollprocessmanual_ID, String strRcpl_Emppprocessmanual_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/EmployeesA88CE224AC9E4285B9742794796EC056_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056", false, "document.frmMain.inprcplEmppprocessmanualId", "grid", "..", "".equals("Y"), "Grievences", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("51759349FEFB4BFBAF71D551F41C71DD", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056_Relation.html", "Grievences", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", EmployeesA88CE224AC9E4285B9742794796EC056Data.selectParent(this, strPRcpl_Payrollprocessmanual_ID));
    else xmlDocument.setParameter("parent", EmployeesA88CE224AC9E4285B9742794796EC056Data.selectParentTrl(this, strPRcpl_Payrollprocessmanual_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRcpl_Emppprocessmanual_ID, String strPRcpl_Payrollprocessmanual_ID, TableSQLData tableSQL)
    ...
    EmployeesA88CE224AC9E4285B9742794796EC056Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = EmployeesA88CE224AC9E4285B9742794796EC056Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPRcpl_Payrollprocessmanual_ID, strRcpl_Emppprocessmanual_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new EmployeesA88CE224AC9E4285B9742794796EC056Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = EmployeesA88CE224AC9E4285B9742794796EC056Data.set(strPRcpl_Payrollprocessmanual_ID, Utility.getDefault(this, vars, "Processed", "N", "BA00CD9835D0423193FAB5395377FA71", "N", dataField), Utility.getDefault(this, vars, "Rcpr_Shift_ID", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Complete", "N", "BA00CD9835D0423193FAB5395377FA71", "N", dataField), Utility.getDefault(this, vars, "Attddate", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Rchr_Employee_ID", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), "", Utility.getDefault(this, vars, "Description", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), EmployeesA88CE224AC9E4285B9742794796EC056Data.selectDef2B8100ADF9194ABDA03D1F8AF94512F6_0(this, Utility.getDefault(this, vars, "Updatedby", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Daytype", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Process", "N", "BA00CD9835D0423193FAB5395377FA71", "N", dataField), Utility.getDefault(this, vars, "Otprocess", "N", "BA00CD9835D0423193FAB5395377FA71", "N", dataField), "Y", Utility.getDefault(this, vars, "Punchin", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Manualpresents", "N", "BA00CD9835D0423193FAB5395377FA71", "N", dataField), Utility.getDefault(this, vars, "Rchr_Dailyattend_ID", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField), EmployeesA88CE224AC9E4285B9742794796EC056Data.selectDefE2FDF006E80940439BE56D69655CB054_1(this, Utility.getDefault(this, vars, "Createdby", "", "BA00CD9835D0423193FAB5395377FA71", "", dataField)));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/EmployeesA88CE224AC9E4285B9742794796EC056_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/EmployeesA88CE224AC9E4285B9742794796EC056_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprcplEmppprocessmanualId", "", "..", "".equals("Y"), "Grievences", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRcpl_Emppprocessmanual_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056_Relation.html", "Grievences", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "EmployeesA88CE224AC9E4285B9742794796EC056_Relation.html", strReplaceWith);
...
comboTableData = null;
xmlDocument.setParameter("Complete_BTNname", Utility.getButtonName(this, vars, "89EF2905FF3F4D29B165AE2D10D66B24", "Complete_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalComplete = org.openbravo.erpCommon.utility.Utility.isModalProcess("E038F781230D4505AAADDE1EBFD2573E"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "EmployeesA88CE224AC9E4285B9742794796EC056_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (EmployeesA88CE224AC9E4285B9742794796EC056Data.getCurrentDBTimestamp(this, data.rcplEmppprocessmanualId).equals(
  ...
  public String getServletInfo() {
    return "Servlet EmployeesA88CE224AC9E4285B9742794796EC056. This Servlet was made by Wad constructor";
