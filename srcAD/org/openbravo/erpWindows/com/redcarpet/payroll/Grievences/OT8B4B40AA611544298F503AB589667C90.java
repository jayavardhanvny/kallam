...
public class OT8B4B40AA611544298F503AB589667C90 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(OT8B4B40AA611544298F503AB589667C90.class);
  
  private static final String windowId = "BA00CD9835D0423193FAB5395377FA71";
  private static final String tabId = "8B4B40AA611544298F503AB589667C90";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDescription", tabId + "|paramDescription");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strRcpl_Emppprocessmanual_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.view", strView);
        }
      }
      ...
      String strRcpl_Emppprocessmanual_ID = vars.getGlobalVariable("inprcplEmppprocessmanualId", windowId + "|Rcpl_Emppprocessmanual_ID", "");
      vars.setSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.view", "RELATION");
...
vars.getGlobalVariable("inprcplPayrollprocessmanualId", windowId + "|Rcpl_Payrollprocessmanual_ID");
      ...
      vars.setSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPRcpl_Payrollprocessmanual_ID = vars.getGlobalVariable("inprcplPayrollprocessmanualId", windowId + "|Rcpl_Payrollprocessmanual_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|OT8B4B40AA611544298F503AB589667C90.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Rcpl_Emppprocessmanual_ID");
      vars.setSessionValue(windowId + "|Rcpl_Payrollprocessmanual_ID", strPRcpl_Payrollprocessmanual_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strRcpl_Emppprocessmanual_ID = vars.getRequiredStringParameter("inprcplEmppprocessmanualId");
      //OT8B4B40AA611544298F503AB589667C90Data data = getEditVariables(vars, strPRcpl_Payrollprocessmanual_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = OT8B4B40AA611544298F503AB589667C90Data.delete(this, strRcpl_Emppprocessmanual_ID, strPRcpl_Payrollprocessmanual_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private OT8B4B40AA611544298F503AB589667C90Data getEditVariables(Connection con, VariablesSecureApp vars, String strPRcpl_Payrollprocessmanual_ID) throws IOException,ServletException {
    OT8B4B40AA611544298F503AB589667C90Data data = new OT8B4B40AA611544298F503AB589667C90Data();
  ...
  private String getParentID(VariablesSecureApp vars, String strRcpl_Emppprocessmanual_ID) throws ServletException {
    String strPRcpl_Payrollprocessmanual_ID = OT8B4B40AA611544298F503AB589667C90Data.selectParentID(this, strRcpl_Emppprocessmanual_ID);
    if (strPRcpl_Payrollprocessmanual_ID.equals("")) {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPRcpl_Payrollprocessmanual_ID, String strRcpl_Emppprocessmanual_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/OT8B4B40AA611544298F503AB589667C90_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90", false, "document.frmMain.inprcplEmppprocessmanualId", "grid", "..", "".equals("Y"), "Grievences", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("2F7E1453CF184F7186984BBC99C0E689", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90_Relation.html", "Grievences", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", OT8B4B40AA611544298F503AB589667C90Data.selectParent(this, strPRcpl_Payrollprocessmanual_ID));
    else xmlDocument.setParameter("parent", OT8B4B40AA611544298F503AB589667C90Data.selectParentTrl(this, strPRcpl_Payrollprocessmanual_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRcpl_Emppprocessmanual_ID, String strPRcpl_Payrollprocessmanual_ID, TableSQLData tableSQL)
    ...
    OT8B4B40AA611544298F503AB589667C90Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = OT8B4B40AA611544298F503AB589667C90Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPRcpl_Payrollprocessmanual_ID, strRcpl_Emppprocessmanual_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new OT8B4B40AA611544298F503AB589667C90Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/OT8B4B40AA611544298F503AB589667C90_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/payroll/Grievences/OT8B4B40AA611544298F503AB589667C90_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprcplEmppprocessmanualId", "", "..", "".equals("Y"), "Grievences", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRcpl_Emppprocessmanual_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90_Relation.html", "Grievences", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "OT8B4B40AA611544298F503AB589667C90_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Complete_BTNname", Utility.getButtonName(this, vars, "7FC67E2717804AF78A519263CAF27E0A", "Complete_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalComplete = org.openbravo.erpCommon.utility.Utility.isModalProcess("E038F781230D4505AAADDE1EBFD2573E"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "OT8B4B40AA611544298F503AB589667C90_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (OT8B4B40AA611544298F503AB589667C90Data.getCurrentDBTimestamp(this, data.rcplEmppprocessmanualId).equals(
  ...
  public String getServletInfo() {
    return "Servlet OT8B4B40AA611544298F503AB589667C90. This Servlet was made by Wad constructor";
