...
package org.openbravo.erpWindows.com.redcarpet.goodsissue.YarnIssue;
...
vars.getRequestGlobalVariable("inpParamDocumentno", tabId + "|paramDocumentno");
  ...
  private Header8A64417BE54C46B7ABD14CFA924540BEData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.rchrEmpDeptId = vars.getRequiredStringParameter("inprchrEmpDeptId");     data.description = vars.getStringParameter("inpdescription");     data.createfromindent = vars.getStringParameter("inpcreatefromindent", "N");     data.createlines = vars.getStringParameter("inpcreatelines", "N");     data.process = vars.getRequiredInputGlobalVariable("inpprocess", windowId + "|Process", "N");     data.postx = vars.getRequiredStringParameter("inppostx");     data.processed = vars.getStringParameter("inpprocessed", "N");    try {   data.totallines = vars.getNumericParameter("inptotallines");  } catch (ServletException paramEx) { ex = paramEx; }     data.completenew = vars.getStringParameter("inpcompletenew");     data.docstatus = vars.getStringParameter("inpdocstatus");     data.docstatusr = vars.getStringParameter("inpdocstatus_R");     data.rchrJobcardId = vars.getStringParameter("inprchrJobcardId");     data.copyfromtransactions = vars.getRequiredStringParameter("inpcopyfromtransactions");     data.newcopy = vars.getRequiredStringParameter("inpnewcopy");     data.rchrWarpyarntypeId = vars.getStringParameter("inprchrWarpyarntypeId");     data.rchrWarpyarntypeIdr = vars.getStringParameter("inprchrWarpyarntypeId_R");     data.epcgVariantId = vars.getStringParameter("inpepcgVariantId");     data.epcgVariantIdr = vars.getStringParameter("inpepcgVariantId_R");     data.epcgConetypeId = vars.getStringParameter("inpepcgConetypeId");     data.epcgConetypeIdr = vars.getStringParameter("inpepcgConetypeId_R");     data.rcgiMaterialindentId = vars.getRequiredStringParameter("inprcgiMaterialindentId");     data.rcgiMaterialindentlinesId = vars.getStringParameter("inprcgiMaterialindentlinesId");     data.rcgiMaterialindentlinesIdr = vars.getStringParameter("inprcgiMaterialindentlinesId_R");     data.rcgiMaterialissueId = vars.getRequestGlobalVariable("inprcgiMaterialissueId", windowId + "|Rcgi_Materialissue_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inpselectyarnstock", windowId + "|SelectYarnStock", "");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strRcgi_Materialissue_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/goodsissue/YarnIssue/Header8A64417BE54C46B7ABD14CFA924540BE_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header8A64417BE54C46B7ABD14CFA924540BE", false, "document.frmMain.inprcgiMaterialissueId", "grid", "..", "".equals("Y"), "YarnIssue", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header8A64417BE54C46B7ABD14CFA924540BE_Relation.html", "YarnIssue", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strRcgi_Materialissue_ID, TableSQLData tableSQL)
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/goodsissue/YarnIssue/Header8A64417BE54C46B7ABD14CFA924540BE_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/redcarpet/goodsissue/YarnIssue/Header8A64417BE54C46B7ABD14CFA924540BE_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header8A64417BE54C46B7ABD14CFA924540BE", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inprcgiMaterialissueId", "", "..", "".equals("Y"), "YarnIssue", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strRcgi_Materialissue_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header8A64417BE54C46B7ABD14CFA924540BE_Relation.html", "YarnIssue", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header8A64417BE54C46B7ABD14CFA924540BE_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("SelectYarnStock", strSelectYarnStock);
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "19", "Rcgi_Materialindentlines_ID", "", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("rcgiMaterialindentlinesId"):dataField.getField("rcgiMaterialindentlinesId")));
xmlDocument.setData("reportRcgi_Materialindentlines_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
