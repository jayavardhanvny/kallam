...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "action", straction, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.name = vars.getRequiredStringParameter("inpname");     data.processing = vars.getStringParameter("inpprocessing");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.description = vars.getStringParameter("inpdescription");     data.posted = vars.getStringParameter("inpposted", "N");     data.status = vars.getRequiredGlobalVariable("inpstatus", windowId + "|Status");     data.processed = vars.getRequiredInputGlobalVariable("inpprocessed", windowId + "|Processed", "N");     data.mInternalConsumptionId = vars.getRequestGlobalVariable("inpmInternalConsumptionId", windowId + "|M_Internal_Consumption_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
