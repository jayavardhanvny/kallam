...
vars.getGlobalVariable("inpmaMeasureGroupId", windowId + "|MA_Measure_Group_ID");
  ...
  private TimeData getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_Measure_Group_ID) throws IOException,ServletException {
    ...
    try {
    data.measurehour = vars.getRequiredStringParameter("inpmeasurehour");     data.maMeasureGroupId = vars.getRequiredStringParameter("inpmaMeasureGroupId");     data.maMeasureGroupIdr = vars.getStringParameter("inpmaMeasureGroupId_R");     data.explode = vars.getStringParameter("inpexplode");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.maMeasureTimeId = vars.getRequestGlobalVariable("inpmaMeasureTimeId", windowId + "|MA_Measure_Time_ID"); 
