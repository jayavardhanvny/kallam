...
package org.openbravo.erpWindows.Indent;
...
public class Indent extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Indent.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Indent.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Indent.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDocStatus", tabId + "|paramDocStatus");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Requisition_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Indent.view", strView);
        }
      }
      ...
      String strM_Requisition_ID = vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID", "");
      vars.setSessionValue(tabId + "|Indent.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|Indent.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Indent.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Indent.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Requisition_ID");
      ...
      String strM_Requisition_ID = vars.getRequiredStringParameter("inpmRequisitionId");
      //IndentData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = IndentData.delete(this, strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
String stradTableId = "800212";
        ...
        try {
          ...
          IndentData.updateDocAction(this, strdocaction, strM_Requisition_ID);
  ...
  private IndentData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    IndentData data = new IndentData();
    ServletException ex = null;
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.emRcobIndentdate = vars.getRequiredStringParameter("inpemRcobIndentdate");     data.emRcobDeliverydate = vars.getStringParameter("inpemRcobDeliverydate");     data.mProductCategoryId = vars.getStringParameter("inpmProductCategoryId");     data.description = vars.getStringParameter("inpdescription");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.adUserId = vars.getRequiredStringParameter("inpadUserId");     data.adUserIdr = vars.getStringParameter("inpadUserId_R");     data.mPricelistId = vars.getRequestGlobalVariable("inpmPricelistId", windowId + "|M_PriceList_ID");     data.cCurrencyId = vars.getRequestGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.rchrEmpDeptId = vars.getStringParameter("inprchrEmpDeptId");     data.rchrEmpDeptIdr = vars.getStringParameter("inprchrEmpDeptId_R");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.docstatus = vars.getRequiredStringParameter("inpdocstatus");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.createpo = vars.getRequiredStringParameter("inpcreatepo");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.mRequisitionId = vars.getRequestGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
         ...
         if (data.documentno.startsWith("<")) data.documentno = Utility.getDocumentNo(con, this, vars, windowId, "M_Requisition", "", data.cDoctypeId, false, true);
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      IndentData[] data = IndentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpmRequisitionId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Indent/Indent_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Indent", false, "document.frmMain.inpmRequisitionId", "grid", "../com.rcss.humanresource/erpCommon/ad_reports/ReportIndent.pdf", "N".equals("Y"), "Indent", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Indent_Relation.html", "Indent", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Indent_Relation.html", strReplaceWith);
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = IndentData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = IndentData.set(Utility.getDefault(this, vars, "Createpo", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "800092", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "C_Doctype_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Rcob_Indentdate", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Rcob_Deliverydate", "", "800092", "", dataField), Utility.getDefault(this, vars, "Rchr_Emp_Dept_Id", "", "800092", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "", "800092", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800092", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField), IndentData.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField), IndentData.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800092", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800092", "", dataField));
             data[0].documentno = "<" + Utility.getDocumentNo( this, vars, windowId, "M_Requisition", "", data[0].cDoctypeId, false, false) + ">";
      }
     }
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Indent/Indent_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Indent/Indent_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Indent", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmRequisitionId", "", "../com.rcss.humanresource/erpCommon/ad_reports/ReportIndent.pdf", "N".equals("Y"), "Indent", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Requisition_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Indent_Relation.html", "Indent", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Indent_Relation.html", strReplaceWith);
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "C_Doctype_ID", "9336FC9FBF63433DB131065F0EA374C0", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
comboTableData = null;
xmlDocument.setParameter("EM_Rcob_Indentdate_Format", vars.getSessionValue("#AD_SqlDateFormat"));
xmlDocument.setParameter("EM_Rcob_Deliverydate_Format", vars.getSessionValue("#AD_SqlDateFormat"));
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Rchr_Emp_Dept_Id", "2CAB2644B21E473388F9D6F6A426F662", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Indent_Edition.html");
...
xmlDocument.setParameter("array", dact.toString());
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (IndentData.getCurrentDBTimestamp(this, data.mRequisitionId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Indent. This Servlet was made by Wad constructor";
