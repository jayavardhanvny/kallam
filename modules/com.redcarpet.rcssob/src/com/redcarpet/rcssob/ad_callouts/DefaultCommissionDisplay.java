...
public class DefaultCommissionDisplay extends SimpleCallout {

    @Override
    protected void execute(CalloutInfo info) throws ServletException {


    	String agentId = info.getStringParameter("inpemEpcgBusinessagent", null);
        ...
        System.out.println("commission is...." +commission);
            ...
            info.addResult("inpemRcobCommission", commission);
