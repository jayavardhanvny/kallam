...
public class PayrollDeductionReport extends HttpSecureAppServlet {
...
//		String strdeptId="";
		...
		String strPayrollId = vars.getGlobalVariable("inpPayrollId",
					"PayrollDeductionReport|payrollid", "");
		String strempType = vars.getGlobalVariable("inpEmployeeType", "PayrollDeductionReport|employeetype","");
      	//stremployeeId = vars.getGlobalVariable("inpEmployee",
				//"PayrollDeductionReport|employee", "");
      	String strDuductionId = vars.getGlobalVariable("inpDeduction",
				"PayrollDeductionReport|payrollid", "");
      	String strBranch = vars.getRequestGlobalVariable("inpbranch",
				"PayrollDeductionReport|branch");
	/*	strdeptId = vars.getRequestGlobalVariable("inpDept",
				"PayrollDeductionReport|dept");
...
*/		String strDuductionId = vars.getRequestGlobalVariable("inpDeduction",
	...
	/*	String strPayroll = vars.getGlobalVariable("inppayroll", 
		...
		String strBank = vars.getRequestGlobalVariable("inpbank", 
				"PayrollDeductionReport|bank");
	*/	//String strempType = vars.getRequestGlobalVariable("inpEmployeeType","PayrollDeductionReport|empType");
		//System.out.println("empid.."+stremployeeId);						
		
		printPagePopUp(request, response, vars, strPayrollId, strempType, strDuductionId, strBranch, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strPayrollId, String strempType, String strDuductionId, String strBranch
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/redcarpet/payroll/erpCommon/ad_reports/PayrollDeductionReport").createXmlDocument();
...
//		xmlDocument.setParameter("rcprSubDeptId", strsubdeptId);
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"PayrollDeductionReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.redcarpet.payroll.erpCommon.ad_reports.PayrollDeductionReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"PayrollDeductionReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"PayrollDeductionReport.html", strReplaceWith);
...
/*				try {
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCPL_PAYDEDUCITIONSHEAD_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "PayrollDeductionReport"),
					Utility.getContext(this, vars, "#User_Client",
							"PayrollDeductionReport"), 0);
...
*/
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strPayrollId, 
		String strempType, String strDuductionId, String strBranch, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/redcarpet/payroll/erpCommon/ad_reports/PayrollDeductionReport").createXmlDocument();
	    

		
		String 	strReportName = "@basedesign@/com/redcarpet/payroll/erpCommon/ad_reports/PayrollDeductionReport.jrxml";
