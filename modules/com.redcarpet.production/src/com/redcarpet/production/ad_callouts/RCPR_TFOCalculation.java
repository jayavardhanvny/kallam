...
public class RCPR_TFOCalculation extends SimpleCallout {
    ...
    protected void execute(CalloutInfo info) throws ServletException {
        ...
        String strProducedHanksVal = fr.format(deProducedHanksVal);
        info.addResult("inpproducedhanks", strProducedHanksVal);
