  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strTabId = vars.getGlobalVariable("inpTabId", "ExecutePayments|Tab_ID", "",
          IsIDFilter.instance);
		  if(strWindowId == "6F8F913FA60F4CBD93DC1D3AA696E76E")
		  {
		  String strPaymentId = vars.getStringParameter("inpfinPaymentId");
     System.out.println("payment id is" + strPaymentId);
     FIN_Payment payment = OBDal.getInstance().get(FIN_Payment.class, strPaymentId);
     
    		 String cblinesId = vars.getStringParameter("inpepcgCblinesId");
    		 System.out.println("cblinesid is" + cblinesId);
    		EPCGCblines cbline = OBDal.getInstance().get(EPCGCblines.class, cblinesId);
         	cbline.setChequestatus("Issued");
         	cbline.setPayment(payment);
