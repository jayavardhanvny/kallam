...
public class SalesOrderDocumentNo extends SimpleCallout {

	@Override
	protected void execute(CalloutInfo info) throws ServletException {
		
        String strDoctypeId = info.getStringParameter("inpcDoctypetargetId", null); 
        
        String strOrderstatusId = info.getStringParameter("inprchrOrderstatusId", null);
        System.out.println("strDoctypeId is " +strDoctypeId);
        
        String strMovementDate = info.getStringParameter("inpdateordered", null);
