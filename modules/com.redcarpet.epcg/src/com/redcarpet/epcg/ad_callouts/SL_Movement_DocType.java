...
public class SL_Movement_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      ...
      String strOrder = vars.getStringParameter("inpmMovementId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    if (strDocType.equals(""))
      ...
      SLMovementDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLMovementDocTypeData.select(this, strDocType);
      ...
      SLMovementDocTypeData[] dataNew = SLMovementDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLMovementDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLMovementDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLMovementDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLMovementDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLMovementDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLMovementDocType", "");
