...
public class SL_MaterialIssue_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      ...
      String strOrder = vars.getStringParameter("inprcgiMaterialissueId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    if (strDocType.equals(""))
      ...
      SLMaterialIssueDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLMaterialIssueDocTypeData.select(this, strDocType);
      ...
      SLMaterialIssueDocTypeData[] dataNew = SLMaterialIssueDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLMaterialIssueDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLMaterialIssueDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLMaterialIssueDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLMaterialIssueDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLMaterialIssueDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLMaterialIssueDocType", "");
