...
public class SL_PreventiveOrder_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      String strDocType = vars.getStringParameter("inpcDoctypeId");
      String docNo = vars.getStringParameter("inpdocumentno");
      String strOrder = vars.getStringParameter("inprcprPreventivemaintenanceId");
      String strDescription = vars.getStringParameter("inpdescription");
      String strTabId = vars.getStringParameter("inpTabId");

      try {
        printPage(response, vars, strDocType, docNo, strOrder,
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
       String strDocType, String docNo, String strOrder,
    ...
    if (strDocType.equals(""))
      ...
      resultado.append("var calloutName='SL_Movement_DocType';\n\n");
      ...
      SLPreventiveOrderDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLPreventiveOrderDocTypeData.select(this, strDocType);
      ...
      SLPreventiveOrderDocTypeData[] dataNew = SLPreventiveOrderDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLPreventiveOrderDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLPreventiveOrderDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLPreventiveOrderDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
      ...
      if (!DocSubTypeSO.equalsIgnoreCase("WR")) {
    	 /*  SLMovementDocTypeData[] dataBP = SLMovementDocTypeData.BPartner(this, strBPartner);
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLPreventiveOrderDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLPreventiveOrderDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLPreventiveOrderDocType", "");
