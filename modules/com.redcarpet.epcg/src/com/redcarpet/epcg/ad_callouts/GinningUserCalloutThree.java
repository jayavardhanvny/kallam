...
public class GinningUserCalloutThree extends SimpleCallout {
	...
	protected void execute(CalloutInfo info) throws ServletException {
		...
		// System.out.println(lastChanged + " lastChanged");
		  ...
		  try
	        ...
	        String s2 = "select count(*) as total from epcg_ginninguser";
	                   ...
	                   if (r == 0) {                   
	                         System.out.println("inside if");
	                             } else
	                             {
	                                  ...
	                                  String sqlqry = "select addedot,seedprice,gngexp from epcg_ginninguser order by created desc limit 1";
