...
public class SL_MaterialReceipt_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      ...
      String strOrder = vars.getStringParameter("inprcgiMaterialreceiptId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    if (strDocType.equals(""))
      ...
      SLMaterialReceiptDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLMaterialReceiptDocTypeData.select(this, strDocType);
      ...
      SLMaterialReceiptDocTypeData[] dataNew = SLMaterialReceiptDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLMaterialReceiptDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLMaterialReceiptDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLMaterialReceiptDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLMaterialReceiptDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLMaterialReceiptDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLMaterialReceiptDocType", "");
