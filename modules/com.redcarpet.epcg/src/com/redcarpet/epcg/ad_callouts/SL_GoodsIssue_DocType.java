...
public class SL_GoodsIssue_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      ...
      String strOrder = vars.getStringParameter("inprcgiGoodsissueId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    if (strDocType.equals(""))
      ...
      SLGoodsIssueDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLGoodsIssueDocTypeData.select(this, strDocType);
      ...
      SLGoodsIssueDocTypeData[] dataNew = SLGoodsIssueDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLGoodsIssueDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLGoodsIssueDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLGoodsIssueDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLGoodsIssueDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLGoodsIssueDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLGoodsIssueDocType", "");
