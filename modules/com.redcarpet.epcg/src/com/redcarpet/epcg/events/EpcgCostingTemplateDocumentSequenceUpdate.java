...
public class EpcgCostingTemplateDocumentSequenceUpdate extends EntityPersistenceEventObserver {

	private static Entity entities[] = { ModelProvider.getInstance().getEntity(EpcgYarncosttemplate.ENTITY_NAME) };
	protected Logger logger = Logger.getLogger(EpcgYarncosttemplate.ENTITY_NAME);
	...
	public void onSave(@Observes EntityNewEvent event) {
		...
		final EpcgYarncosttemplate issue = (EpcgYarncosttemplate)event.getTargetInstance();
		...
		Date gidate=issue.getCostingdate();
		
		String status="";
		
		Date aDate=issue.getCostingdate();
