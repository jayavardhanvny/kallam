...
public class DailyProductionReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"DailyProductionReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"DailyProductionReport|dateTo", "");


		String strOrgId = vars.getGlobalVariable("inpadOrgId",
				"DailyProductionReport|orgId", "");
		String strOrder = vars.getGlobalVariable("inpOrder", "DailyProductionReport|Order", "PurchaseOrder");
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/redcarpet/epcg/erpCommon/ad_reports/DailyProductionReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"DailyProductionReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.redcarpet.epcg.erpCommon.ad_reports.DailyProductionReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"DailyProductionReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"DailyProductionReport.html", strReplaceWith);
			xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
		} catch (Exception ex) {
			throw new ServletException(ex);
		}
	/*	{
			OBError myMessage = vars.getMessage("DailyProductionReport");
			vars.removeMessage("DailyProductionReport");
			if (myMessage != null) {
		...
		try {
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "AD_Org_ID", "", "Org Validation", Utility.getContext(
							this, vars, "#User_Org", "DailyProductionReport"),
					Utility.getContext(this, vars, "#User_Client",
							"DailyProductionReport"), 0);
	...
	private void printPagePopUp(HttpServletRequest request,	HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrgId, String strOrder, String strOutput) throws IOException, ServletException {
		...
		if (strOrder.equals("PurchaseOrder")) {
			strReportType="Material Receipt";
            strReportName = "@basedesign@/com/redcarpet/epcg/erpCommon/ad_reports/ReportMaterialReceipt.jrxml";
        } else {
        	strReportType="Material Issue";
            strReportName = "@basedesign@/com/redcarpet/epcg/erpCommon/ad_reports/ReportMaterialIssue.jrxml";
        }
