 ...
 * @author S.A. Mateen
 */
public class RCGI_MaterialIssue_Post extends DalBaseProcess {
    ...
    protected void doExecute(ProcessBundle bundle) throws Exception {
        ...
        RCGISelectAcctNewOneData[] data1 = RCGISelectAcctNewOneData.getProductCreditAccountData(new DalConnectionProvider(), client, client, org, id);
        RCGISelectAcctNewOneData[] data2 = RCGISelectAcctNewOneData.getProductDebitAccountData(new DalConnectionProvider(), client, client, org, id);
        ...
        //credit
        for (RCGISelectAcctNewOneData t1 : data1) {
            insertProductionIssues2(t1.cAcctschemaId, t1.cElementvalueId, t1.cPeriodId, t1.asTableId, gi.getId(), t1.cCurrencyId,
                    ...
                    t1.qty, groupId1, t1.value, gi.getDocumentNo() + "#Product Material Issue", t1.mProductId);
            seqNo = seqNo + 10;
        }
        //debit
        for (RCGISelectAcctNewOneData t1 : data2) {
            insertProductionIssues2(t1.cAcctschemaId, t1.cElementvalueId, t1.cPeriodId, t1.asTableId, gi.getId(), t1.cCurrencyId,
    ...
    private String getLineNetAmt(String strClientId, String mProductId, String strQty, String strLocatorId, String strUnitprice) throws ServletException {
        ...
        String strCost = RCGIProductCostNewOneData.getCostingLines(new DalConnectionProvider(), strClientId, mProductId, strWarehouseId);
        boolean isStrCostNull = StringUtils.equalsIgnoreCase(strCost, "");
        if (isStrCostNull) {
            String strPriceListCost = RCGIProductCostNewOneData.getPriceListCost(new DalConnectionProvider(), mProductId);
