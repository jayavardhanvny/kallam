...
public class ReportEmployeeFine extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("ReportEmployeeFine.inprcplEmpfineId_R");		//	inprcplEmpfineId
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("ReportEmployeeFine.inprcplEmpfineId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    parameters.put("EmpFine_ID", strPermissionId);
	    ...
	    try {
	         strPermissionId = strPermissionId.replaceAll("\\(|\\)|'", "");
	          ...
	          + "/com/rcss/humanresource/erpCommon/ad_reports/ReportEmployeeFine.jrxml");
