...
public class BreakDurationReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		*/	
		...
		String strdesignationId = vars.getRequestGlobalVariable("inpDesignation",
				"BreakDurationReport|designation");
		printPagePopUp(request, response, vars, strDateFrom, strDateTo, stremployeeId, strshiftId, strdeptId, strsubdeptId, strdesignationId, "pdfview");
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/BreakDurationReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"BreakDurationReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.BreakDurationReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"BreakDurationReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"BreakDurationReport.html", strReplaceWith);
		...
		try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCHR_EMP_DEPT_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "BreakDurationReport"),
					Utility.getContext(this, vars, "#User_Client",
							"BreakDurationReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"BreakDurationReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId, String strshiftId, String strdeptId, String strsubdeptId, String strdesignationId, String strOutput) throws IOException, ServletException {
		...
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/BreakDurationReport.jrxml";
