...
public class Dailyattendancereport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"Dailyattendancereport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"Dailyattendancereport|dateTo", "");
      
		String stremployeeId = vars.getGlobalVariable("inpEmployee",
				"Dailyattendancereport|employee", "");
		String strempType = vars.getGlobalVariable("inpEmployeeType",
				"Dailyattendancereport|employeetype", "");
		...
		*/	
		printPage(response, vars, strDateFrom, strDateTo, stremployeeId, strempType, strdeptId, strsubdeptId, strdesignationId);
		} 
	...
	String strdesignationId = vars.getRequestGlobalVariable("inpDesignation",
		...
		String strOrder = vars.getGlobalVariable("inpOrder", "EmployeeAttendanceSummaryReport|Order", "PunchOrder");
		*/	
		printPagePopUp(request, response, vars, strDateFrom, strDateTo, stremployeeId, strempType, strdeptId, strsubdeptId, strdesignationId, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId, String strempType, String strdeptId, String strsubdeptId, String strdesignationId
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/Dailyattendancereport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"Dailyattendancereport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.Dailyattendancereport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"Dailyattendancereport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"Dailyattendancereport.html", strReplaceWith);
			...
			*/	try {
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCHR_EMPLOYEE_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "Dailyattendancereport"),
					Utility.getContext(this, vars, "#User_Client",
							"Dailyattendancereport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId, String strempType, String strdeptId, String strsubdeptId, String strdesignationId, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/Dailyattendancereport").createXmlDocument();
	
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/Dailyattendancereport.jrxml";
