...
public class Vehiclegatepass extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("Vehiclegatepass.inprchrVehiclegatepassId_R");  
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("Vehiclegatepass.inprchrVehiclegatepassId");
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    try {
	    	String strBaseDesign=null;
	         ...
	         strBaseDesign  = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/Vehiclegatepass.jrxml";
