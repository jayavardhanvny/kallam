...
public class ReportDepartmentalStore extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("ReportDepartmentalStore.inprcplDeprtmtstorerequsitionId_R");
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("ReportDepartmentalStore.inprcplDeprtmtstorerequsitionId");
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    try {
	         strPermissionId = strPermissionId.replaceAll("\\(|\\)|'", "");
	          ...
	          + "/com/rcss/humanresource/erpCommon/ad_reports/ReportDepartmentalStore.jrxml");
