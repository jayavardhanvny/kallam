...
public class EmployeeTwelveHrsShiftReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"EmployeeTwelveHrsShiftReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"EmployeeTwelveHrsShiftReport|dateTo", "");

		String stremployeeId = vars.getGlobalVariable("inpEmployee",
				"EmployeeTwelveHrsShiftReport|employee", "");
		//String strshiftId = vars.getGlobalVariable("inpShift",
				//"EmployeeTwelveHrsShiftReport|shift", "");
		String strOrder = vars.getGlobalVariable("inpOrder", "EmployeeTwelveHrsShiftReport|Order", "PunchOrder");
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/EmployeeTwelveHrsShiftReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"EmployeeTwelveHrsShiftReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.EmployeeTwelveHrsShiftReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"EmployeeTwelveHrsShiftReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"EmployeeTwelveHrsShiftReport.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCHR_EMPLOYEE_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "EmployeeTwelveHrsShiftReport"),
					Utility.getContext(this, vars, "#User_Client",
							"EmployeeTwelveHrsShiftReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"EmployeeTwelveHrsShiftReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strOrder, String stremployeeId, String strOutput) throws IOException, ServletException {
		...
		if(strOrder.equals("PunchOrder")){
		   strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/EmployeeTwelveHrsShiftReport2.jrxml";
		}else
		{
		   strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/EmployeeTwelveHrsShiftReport.jrxml";
		}
		/*if(strOrder.equals("PunchOrder")){
			strOrder="ConOne";
		}else
