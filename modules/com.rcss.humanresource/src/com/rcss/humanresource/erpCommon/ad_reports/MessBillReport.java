...
public class MessBillReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"MessBillReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"MessBillReport|dateTo", "");

		String stremployeeId = vars.getGlobalVariable("inpEmployee",
				"MessBillReport|employee", "");
		String strempType = vars.getGlobalVariable("inpEmployeeType",
				"MessBillReport|employeetype", "");
		String strmesstypeId = vars.getGlobalVariable("inpMesstype",
				"MessBillReport|messtype", "");
		//String strshiftId = vars.getGlobalVariable("inpShift",
				//"MessBillReport|shift", "");
		//String strOrder = vars.getGlobalVariable("inpOrder", "MessBillReport|Order", "PunchOrder");
			printPage(response, vars, strDateFrom, strDateTo, stremployeeId, strempType, strmesstypeId);
		} 
		...
		//String strshiftId = vars.getRequestGlobalVariable("inpShift",
				//"MessBillReport|shift");
		//String strOrder = vars.getGlobalVariable("inpOrder", "MessBillReport|Order", "PunchOrder");
			printPagePopUp(request, response, vars, strDateFrom, strDateTo, stremployeeId, strempType, strmesstypeId, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId, String strempType, String strmesstypeId
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/MessBillReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"MessBillReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.MessBillReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"MessBillReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"MessBillReport.html", strReplaceWith);
	...
	/*	try {
			...
			throw new ServletException(ex);
				...
				try {
					ComboTableData comboTableData = new ComboTableData(vars, this,
							"TABLEDIR", "RCPL_MESSTYPE_ID", "", "", Utility.getContext(
									this, vars, "#User_Org", "MessBillReport"),
							Utility.getContext(this, vars, "#User_Client",
									"MessBillReport"), 0);
					Utility.fillSQLParameters(this, vars, null, comboTableData,
							"MessBillReport", "");
					xmlDocument.setData("reportRCPL_MESSTYPEID", "liststructure",
							comboTableData.select(false));
					comboTableData = null;
				} catch (Exception ex) {
					throw new ServletException(ex);
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId, String strempType, String strmesstypeId, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/MessBillReport").createXmlDocument();
	    
		String 	strReportName;
		
		   strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/MessBillReport.jrxml";
