...
public class PrepratorySummaryReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"PrepratorySummaryReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"PrepratorySummaryReport|dateTo", "");
		
		String stremployeeId = vars.getGlobalVariable("inpEmployee",
				"LatecomingReport|employee", "");
		
		String strPrep = vars.getGlobalVariable("inpprep", 
				"PrepratorySummaryReport|Prep", "");
		
		//String strloomId = vars.getGlobalVariable("inpLoom",
		//		"PrepratorySummaryReport|loom", "");
	//	String strshiftId = vars.getGlobalVariable("inpShift",
		//		"PrepratorySummaryReport|shift", "");
		//String strsubdeptId = vars.getGlobalVariable("inpSubDept",
			//	"PrepratorySummaryReport|subdept", "");
		//String strdesignationId = vars.getGlobalVariable("inpDesignation",
			//	"PrepratorySummaryReport|designation", "");
		/*	String strOrder = vars.getGlobalVariable("inpOrder", "PrepratorySummaryReport|Order", "PunchOrder");
		*/	
		printPage(response, vars, strDateFrom, strDateTo, stremployeeId,strPrep);
		} 
		...
		//String stremployeeId = vars.getRequestGlobalVariable("inpEmployee",
			//	"PrepratorySummaryReport|employee");
		//String strdeptId = vars.getRequestGlobalVariable("inpDept",
			//		"PrepratorySummaryReport|dept");	
	...
	//	String strsubdeptId = vars.getRequestGlobalVariable("inpSubDept",
		...
		/*String strOrder = vars.getGlobalVariable("inpOrder", "PrepratorySummaryReport|Order", "PunchOrder");
		*/
		printPagePopUp(request, response, vars, strDateFrom, strDateTo, stremployeeId, strPrep, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId,String strPrep) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/PrepratorySummaryReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"PrepratorySummaryReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.PrepratorySummaryReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"PrepratorySummaryReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"PrepratorySummaryReport.html", strReplaceWith);
		...
		try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCHR_EMP_DEPT_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "PrepratorySummaryReport"),
					Utility.getContext(this, vars, "#User_Client",
							"PrepratorySummaryReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"PrepratorySummaryReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String stremployeeId,String strPrepType, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/PrepratorySummaryReport").createXmlDocument();
	
		String strReportName = null;
		
		if(strPrepType.equals("Summary")){
			strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/PrepratorySummaryReport.jrxml";
		}else if(strPrepType.equals("productionReport")){
			strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/PreparatoryReport.jrxml";
		}
