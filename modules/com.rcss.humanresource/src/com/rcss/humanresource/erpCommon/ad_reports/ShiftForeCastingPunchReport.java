...
public class ShiftForeCastingPunchReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"ShiftForeCastingPunchReport|dateFrom", "");
		//String strDateTo = vars.getGlobalVariable("inpDateTo",
				//	"ShiftForeCastingPunchReport|dateTo", "");
      
		String strdeptId = vars.getGlobalVariable("inpDept",
				"ShiftForeCastingPunchReport|dept", "");
		String strshiftId = vars.getGlobalVariable("inpShift",
				"ShiftForeCastingPunchReport|shift", "");
		String strsubdeptId = vars.getGlobalVariable("inpSubDept",
				"ShiftForeCastingPunchReport|subdept", "");
		String strdesignationId = vars.getGlobalVariable("inpDesignation",
				"ShiftForeCastingPunchReport|designation", "");
		/*	String strOrder = vars.getGlobalVariable("inpOrder", "ShiftForeCastingPunchReport|Order", "PunchOrder");
		*/	
		printPage(response, vars, strDateFrom, strshiftId, strdeptId, strsubdeptId, strdesignationId);
		} 
		...
		//String stremployeeId = vars.getRequestGlobalVariable("inpEmployee",
			//	"ShiftForeCastingPunchReport|employee");
		...
		/*String strOrder = vars.getGlobalVariable("inpOrder", "ShiftForeCastingPunchReport|Order", "PunchOrder");
		*/
		printPagePopUp(request, response, vars, strDateFrom, strshiftId, strdeptId, strsubdeptId, strdesignationId, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strshiftId, String strdeptId, String strsubdeptId, String strdesignationId
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingPunchReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ShiftForeCastingPunchReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.ShiftForeCastingPunchReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"ShiftForeCastingPunchReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"ShiftForeCastingPunchReport.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCHR_EMP_DEPT_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "ShiftForeCastingPunchReport"),
					Utility.getContext(this, vars, "#User_Client",
							"ShiftForeCastingPunchReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"ShiftForeCastingPunchReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strshiftId, String strdeptId, String strsubdeptId, String strdesignationId, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingPunchReport").createXmlDocument();
	
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingPunchReport.jrxml";
