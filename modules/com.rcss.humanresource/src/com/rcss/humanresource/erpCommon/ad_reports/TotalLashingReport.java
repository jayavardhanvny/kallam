...
public class TotalLashingReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"TotalLashingReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"TotalLashingReport|dateTo", "");

		String strloomId = vars.getGlobalVariable("inpLoomcategory",
				"TotalLashingReport|loomcategory", "");
		String sortId = vars.getGlobalVariable("inpQualityStandard",
				"TotalLashingReport|sort", "");
			printPage(response, vars, strDateFrom, strDateTo, strloomId, sortId);
		}
	...
	String sortId = vars.getRequestGlobalVariable("inpQualityStandard",
			"TotalLashingReport|sort");
		printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, sortId, "html");
			...
			String sortId = vars.getRequestGlobalVariable("inpQualityStandard",
					"TotalLashingReport|sort");
			printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, sortId, "xls");
		...
		String sortId = vars.getRequestGlobalVariable("inpQualityStandard",
				"TotalLashingReport|sort");
			printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, sortId, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strDateTo, String strloomId, String sortId
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/TotalLashingReport").createXmlDocument();
...
//		xmlDocument.setParameter("rchrInspectiontypeId", strremarkId);
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"TotalLashingReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.TotalLashingReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"TotalLashingReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"TotalLashingReport.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCPL_INSPLOOMCTGRY_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "TotalLashingReport"),
					Utility.getContext(this, vars, "#User_Client",
							"TotalLashingReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"TotalLashingReport", "");
...
*/
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strloomId, String sortId, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/TotalLashingReport").createXmlDocument();
	
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/TotalLashingReport.jrxml";
