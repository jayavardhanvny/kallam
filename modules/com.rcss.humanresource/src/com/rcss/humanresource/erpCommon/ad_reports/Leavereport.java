...
public class Leavereport extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("Leavereport.inprchrLeaverequisitionId_R");  
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("Leavereport.inprchrLeaverequisitionId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    parameters.put("LeaveId", strPermissionId);
	    JasperReport jasperReportLines;	    
	    try {
	    	String strBaseDesign=null;
	         strPermissionId = strPermissionId.replaceAll("\\(|\\)|'", "");
	         
	         strBaseDesign  = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/Leavereport.jrxml";
