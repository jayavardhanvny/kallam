...
public class ApplicationForGasAdvance extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("ApplicationForGasAdvance.inprchrGasAdvanceId_R");
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("ApplicationForGasAdvance.inprchrGasAdvanceId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    parameters.put("AdvanceId", strPermissionId);
	    ...
	    try {
	    	String strBaseDesign=null;
	         ...
	         strBaseDesign  = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/ApplicationForGasAdvance.jrxml";
