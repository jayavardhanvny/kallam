...
public class InspTotalLashingCrosstab extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"InspTotalLashingCrosstab|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"InspTotalLashingCrosstab|dateTo", "");

		String strloomId = vars.getGlobalVariable("inpLoomcategory",
				"InspTotalLashingCrosstab|loomcategory", "");
			printPage(response, vars, strDateFrom, strDateTo, strloomId);
		}
	...
	String strloomId = vars.getRequestGlobalVariable("inpLoomcategory",
			"InspTotalLashingCrosstab|loomcategory");
		printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, "html");
			...
			String strloomId = vars.getRequestGlobalVariable("inpLoomcategory",
					"InspTotalLashingCrosstab|loomcategory");
			printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, "xls");
		...
		String strloomId = vars.getRequestGlobalVariable("inpLoomcategory",
				"InspTotalLashingCrosstab|loomcategory");
			printPagePopUp(request, response, vars, strDateFrom, strDateTo, strloomId, "pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom, String strDateTo, String strloomId
			) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/InspTotalLashingCrosstab").createXmlDocument();
...
//		xmlDocument.setParameter("rchrInspectiontypeId", strremarkId);
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"InspTotalLashingCrosstab", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.InspTotalLashingCrosstab");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"InspTotalLashingCrosstab.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"InspTotalLashingCrosstab.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCPL_INSPLOOMCTGRY_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "InspTotalLashingCrosstab"),
					Utility.getContext(this, vars, "#User_Client",
							"InspTotalLashingCrosstab"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"InspTotalLashingCrosstab", "");
...
*/
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strloomId, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/InspTotalLashingCrosstab").createXmlDocument();
	
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/InspTotalLashingCrosstab.jrxml";
...
//	parameters.put("Remark_ID", strremarkId);
	parameters.put("LoomctgryId", strloomId);
