...
public class ShiftForeCastingReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"ShiftForeCastingReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"ShiftForeCastingReport|dateTo", "");
		
		String strReportType = vars.getGlobalVariable("inpOrder",
				"ShiftForeCastingReport|inpOrder", "");
		
		
		String strDateFromTwelve = vars.getGlobalVariable("inpDateFromTwelve",
				"ShiftForeCastingReport|dateFromTwelve", "");
		...
		/*	String strOrder = vars.getGlobalVariable("inpOrder", "ShiftForeCastingReport|Order", "PunchOrder");
		*/	
		printPage(response, vars, strDateFrom,strDateTo, strshiftId, strdeptId, strsubdeptId, strdesignationId,strDateFromTwelve);
		} 
		...
		//String stremployeeId = vars.getRequestGlobalVariable("inpEmployee",
			//	"ShiftForeCastingReport|employee");
		...
		/*String strOrder = vars.getGlobalVariable("inpOrder", "ShiftForeCastingReport|Order", "PunchOrder");
		*/
		printPagePopUp(request, response, vars, strDateFrom,strDateTo, strshiftId, strdeptId, strsubdeptId, strdesignationId, strDateFromTwelve,strReportType,"pdf");
		}
	...
	private void printPage(HttpServletResponse response,
			VariablesSecureApp vars, String strDateFrom,String strDateTo,String strshiftId, String strdeptId, String strsubdeptId, 
			String strdesignationId,String strDateFromTwelve) throws IOException,
			ServletException {
	

XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"ShiftForeCastingReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.ShiftForeCastingReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"ShiftForeCastingReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"ShiftForeCastingReport.html", strReplaceWith);
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, 
			VariablesSecureApp vars, String strDateFrom,String strDateTo, String strshiftId, String strdeptId, String strsubdeptId, 
			String strdesignationId,String strDateFromTwelve, String strReportType, String strOutput) throws IOException, ServletException {
		XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingReport").createXmlDocument();
		...
		*/
		...
		Date fromDate = null;
		Date toDate = null;
		Date fromDateTwelve = null;
		try{
			fromDate = sdf.parse(strDateFrom);
			toDate = sdf.parse(strDateTo);
			fromDateTwelve = sdf.parse(strDateFromTwelve);
		}catch(Exception e){
    ...
    if(strReportType.equals("twelveHrs")){
    	parameters.put("FromD", fromDateTwelve);
    	 parameters.put("toDate", toDate);
		strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/ShiftForecastingTwelve.jrxml";
	}else{
		parameters.put("FromD", fromDate);
		strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/ShiftForeCastingReport.jrxml";
	}
