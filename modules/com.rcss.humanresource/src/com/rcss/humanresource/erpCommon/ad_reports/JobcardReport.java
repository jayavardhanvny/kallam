...
public class JobcardReport extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (vars.commandIn("DEFAULT")) {
      String strPermissionId = vars.getSessionValue("JobcardReport.inprchrJobcardId_R");
      if (strPermissionId.equals(""))
        strPermissionId = vars.getSessionValue("JobcardReport.inprchrJobcardId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
	  ...
	  if (log4j.isDebugEnabled())
	    ...
	    parameters.put("jobcard", strPermissionId);
	    ...
	    try {
	    	String strBaseDesign=null;
	         ...
	         strBaseDesign  = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/JobcardReport.jrxml";
