...
public class InspDamageGraphReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"InspDamageGraphReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"InspDamageGraphReport|dateTo", "");

		String strloomId = vars.getGlobalVariable("inpLoomcategory",
				"InspDamageGraphReport|loomcategory", "");
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/InspDamageGraphReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"InspDamageGraphReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.InspDamageGraphReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"InspDamageGraphReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"InspDamageGraphReport.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCPL_INSPLOOMCTGRY_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "InspDamageGraphReport"),
					Utility.getContext(this, vars, "#User_Client",
							"InspDamageGraphReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"InspDamageGraphReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strloomId, String strOutput) throws IOException, ServletException {
		...
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/InspDamageGraphReport.jrxml";
