...
public class InspOrderQunatityReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"InspOrderQunatityReport|dateFrom", "");
		String strDateTo = vars.getGlobalVariable("inpDateTo",
					"InspOrderQunatityReport|dateTo", "");

		String strloomId = vars.getGlobalVariable("inpLoomcategory",
				"InspOrderQunatityReport|loomcategory", "");
		String strremarkId = vars.getGlobalVariable("inpInspectoncloth",
				"InspOrderQunatityReport|cloth", "");
		//String strOrder = vars.getGlobalVariable("inpOrder", "InspOrderQunatityReport|Order", "PunchOrder");
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/InspOrderQunatityReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"InspOrderQunatityReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.InspOrderQunatityReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"InspOrderQunatityReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"InspOrderQunatityReport.html", strReplaceWith);
	...
	/*	try {
			...
			ComboTableData comboTableData = new ComboTableData(vars, this,
					"TABLEDIR", "RCPL_INSPLOOMCTGRY_ID", "", "", Utility.getContext(
							this, vars, "#User_Org", "InspOrderQunatityReport"),
					Utility.getContext(this, vars, "#User_Client",
							"InspOrderQunatityReport"), 0);
			Utility.fillSQLParameters(this, vars, null, comboTableData,
					"InspOrderQunatityReport", "");
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strDateTo, String strremarkId, String strloomId, String strOutput) throws IOException, ServletException {
		...
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/InspOrderQunatityReport.jrxml";
