...
public class LoomIncentiveReport extends HttpSecureAppServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strDateFrom = vars.getGlobalVariable("inpDateFrom",
					"LoomIncentiveReport|dateFrom", "");
		//String strDateTo = vars.getGlobalVariable("inpDateTo",
				//	"LoomIncentiveReport|dateTo", "");
		...
		//String strsubdeptId = vars.getGlobalVariable("inpSubDept",
			//	"LoomIncentiveReport|subdept", "");
		//String strdesignationId = vars.getGlobalVariable("inpDesignation",
			//	"LoomIncentiveReport|designation", "");
		/*	String strOrder = vars.getGlobalVariable("inpOrder", "LoomIncentiveReport|Order", "PunchOrder");
		*/	
...
XmlDocument xmlDocument = xmlEngine.readXmlTemplate("com/rcss/humanresource/erpCommon/ad_reports/LoomIncentiveReport").createXmlDocument();
		...
		ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
				"LoomIncentiveReport", false, "", "", "", false, "ad_process",
		...
		try {
			WindowTabs tabs = new WindowTabs(this, vars,
					"com.rcss.humanresource.erpCommon.ad_reports.LoomIncentiveReport");
			...
			NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
					"LoomIncentiveReport.html", classInfo.id, classInfo.type,
					strReplaceWith, tabs.breadcrumb());
			xmlDocument.setParameter("navigationBar", nav.toString());
			LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
					"LoomIncentiveReport.html", strReplaceWith);
	...
	private void printPagePopUp(HttpServletRequest request,HttpServletResponse response, VariablesSecureApp vars, String strDateFrom, String strloomId, String strshiftId, String strOutput) throws IOException, ServletException {
		...
		String 	strReportName = "@basedesign@/com/rcss/humanresource/erpCommon/ad_reports/LoomIncentiveReport.jrxml";
