...
public class SL_Machine_DocType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     // String strDocTypeTarget = vars.getStringParameter("inpcDoctypeId");
      ...
      String strOrder = vars.getStringParameter("inprchrDirectwarpId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    if (strDocType.equals(""))
      ...
      resultado.append("var calloutName='SL_Machine_DocType';\n\n");
      ...
      SLMachineDocTypeData[] data = null;

      if (!newDocNo && !"0".equals(strDocType)) {
        data = SLMachineDocTypeData.select(this, strDocType);
      ...
      SLMachineDocTypeData[] dataNew = SLMachineDocTypeData.select(this, strDocType);
      if (dataNew != null && dataNew.length > 0) {
        DocSubTypeSO = dataNew[0].docsubtypeso;
        if (DocSubTypeSO == null)
          DocSubTypeSO = "--";
        String strOldDocTypeTarget = SLMachineDocTypeData.selectOldDocSubType(this, strOrder);
        if (!DocSubTypeSO.equals("OB") && strOldDocTypeTarget.equals("OB")) {
          String strOldDocNo = SLMachineDocTypeData.selectOldDocNo(this, strOrder);
        ...
        if (dataNew[0].isdocnocontrolled.equals("Y")) {
          if (!newDocNo
              ...
              && !SLMachineDocTypeData.selectOldDocTypeTargetId(this, strOrder).equalsIgnoreCase(
                  strDocType))
            newDocNo = true;
          if (newDocNo) {
        ...
        try {
          ComboTableData comboTableData = new ComboTableData(vars, this, "LIST", "",
              "C_Order InvoiceRule", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
                  "SLMachineDocType"), Utility.getContext(this, vars, "#User_Client",
                  "SLMachineDocType"), 0);
          Utility.fillSQLParameters(this, vars, null, comboTableData, "SLMachineDocType", "");
