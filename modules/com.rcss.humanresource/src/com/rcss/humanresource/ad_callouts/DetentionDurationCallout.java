...
public class DetentionDurationCallout extends SimpleCallout {

    @Override
    protected void execute(CalloutInfo info) throws ServletException {
    	 try {
             String strpunchin = info.getStringParameter("inpdetfromtime", null);
             String strpunchout = info.getStringParameter("inpdettotime", null);
             ...
             if(hours2-hours>0 && mins>=1440){
              info.addResult("inpdettimedifference", newResukt);
              //info.addResult("inpshiftinmins", getShiftInMins(newResukt));
             }else{
             info.addResult("inpdettimedifference", res);
