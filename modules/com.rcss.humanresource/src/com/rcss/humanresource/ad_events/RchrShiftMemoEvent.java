...
public class RchrShiftMemoEvent extends EntityPersistenceEventObserver {

	private static Entity entities[] = { ModelProvider.getInstance().getEntity(RchrMemoShift.ENTITY_NAME) };
	...
	public void onSave(@Observes EntityNewEvent event) {
		...
		final RchrMemoShift issue = (RchrMemoShift)event.getTargetInstance();
		...
		Date gidate=issue.getShiftdate();

		String status="";

		Date aDate=issue.getShiftdate();
