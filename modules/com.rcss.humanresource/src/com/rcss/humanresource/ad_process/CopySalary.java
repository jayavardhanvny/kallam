...
public class CopySalary extends HttpSecureAppServlet {
  ...
  private OBError copyLines(VariablesSecureApp vars, String strRownums, String strKey)
   ...
   // double ot=0;
    ...
    try {
			...
			//}
  	        e.setChequecnt(e.getChequecnt().add(new BigDecimal(1)));
    		while (st.hasMoreTokens()) 
    		{
    			...
    			String strOTEmpLinesId=SequenceIdData.getUUID();    			
       	       ...
       	       try{			
					 ...
					 RchrBanksalpaymentsLn line = OBProvider.getInstance().get(RchrBanksalpaymentsLn.class);
  ...
  private double checkPending(String strKey){
	 ...
	 if(e.getChequecnt().doubleValue()==0)
	 return cnt1;
	 else 
	 return cnt;
  }
...
private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
	...
	xmlDocument = xmlEngine.readXmlTemplate(
			"com/rcss/humanresource/ad_process/CopySalary").createXmlDocument();
